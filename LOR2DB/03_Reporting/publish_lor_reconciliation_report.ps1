param(
    ...
    [string]$BaseUrl = "https://lortodb.sheboyganlights.org/lor2db/reports",
...
#   - Publishes beneath the protected lortodb.sheboyganlights.org/lor2db route.
#
# Change Log:
#   2026-08-04  GAL  V0.1.1
#     Changed the NAS output folder from lortodb to lor2db.
#     Added the protected default report URL:
#       https://lortodb.sheboyganlights.org/lor2db/reports
#
