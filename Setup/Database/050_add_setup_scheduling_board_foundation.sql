...
REVOKE ALL ON FUNCTION ops.create_setup_season_task(
    text,integer,text,integer,bigint,text,integer,integer,integer,integer,
...
REVOKE ALL ON FUNCTION ops.update_setup_annual_task_definition(
    text,bigint,text,integer,bigint,text,integer,integer,integer,
    text,text,text,bigint,boolean,text
) FROM PUBLIC;
...
SELECT
    ...
    to_regprocedure('ops.create_setup_season_task(text,integer,text,integer,bigint,text,integer,integer,integer,integer,text,text,text,bigint,boolean,text)') IS NOT NULL
