...
try {
    ...
    # The Server Management disposable-acceptance standard requires Linux shell
    # files to be normalized before SCP. The version-controlled server runner is
    # the reviewed source; this wrapper does not rewrite its logic at runtime.
