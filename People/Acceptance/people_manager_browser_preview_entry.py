"""Temporary browser-review entry point for the accepted People Manager candidate.

This is acceptance infrastructure, not Production application code. It imports the
exact detached People Manager candidate and injects one explicitly selected
existing operator identity at the WSGI boundary so the candidate's normal
Cloudflare/Directus authorization and governed command code can be exercised
against a disposable PostgreSQL clone.
"""
...
PORT = int(os.environ.get("MSB_PREVIEW_PORT", "8794"))
