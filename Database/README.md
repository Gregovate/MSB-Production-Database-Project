...
LOR snapshot ingest enters PostgreSQL through [LOR2DB Ingest](../LOR2DB/01_Ingest/README.md). LOR-specific reconciliation and promotion belongs to `LOR2DB/`, not this general database folder.
