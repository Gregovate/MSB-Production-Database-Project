...
\restrict J9WhhaS8SWzoLO69DVIbOl7seZMaXdasVFoczE40zwwivsg8KXSjf7nY4YTRsld

-- Dumped from database version 16.9 (Debian 16.9-1.pgdg110+1)
-- Dumped by pg_dump version 18.4

-- Started on 2026-08-31 23:27:27
...
--
-- TOC entry 22 (class 2615 OID 16389)
...
--
-- TOC entry 52 (class 2615 OID 16687)
...
--
-- TOC entry 24 (class 2615 OID 16857)
...
--
-- TOC entry 2187 (class 1247 OID 18888)
...
--
-- TOC entry 2178 (class 1247 OID 18853)
...
--
-- TOC entry 866 (class 1255 OID 18081)
...
--
-- TOC entry 1185 (class 1255 OID 19138)
...
--
-- TOC entry 764 (class 1255 OID 23792)
...
--
-- TOC entry 1261 (class 1255 OID 23794)
...
--
-- TOC entry 643 (class 1255 OID 23656)
...
--
-- TOC entry 1222 (class 1255 OID 23923)
...
--
-- TOC entry 938 (class 1255 OID 25043)
-- Name: f_lor_governed_stage_roots(bigint, text); Type: FUNCTION; Schema: ops; Owner: msbadmin
--

CREATE FUNCTION ops.f_lor_governed_stage_roots(p_import_run_id bigint, p_stage_key text) RETURNS TABLE(folder_path text, folder_name text, stage_name text, evidence_count bigint)
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'lor_snap'
    AS $_$
...
ALTER FUNCTION ops.f_lor_governed_stage_roots(p_import_run_id bigint, p_stage_key text) OWNER TO msbadmin;

--
-- TOC entry 6083 (class 0 OID 0)
-- Dependencies: 938
-- Name: FUNCTION f_lor_governed_stage_roots(p_import_run_id bigint, p_stage_key text); Type: COMMENT; Schema: ops; Owner: msbadmin
--

COMMENT ON FUNCTION ops.f_lor_governed_stage_roots(p_import_run_id bigint, p_stage_key text) IS 'Returns each distinct governed Google Drive Stage/Sub-stage root proven by one frozen lor_snap import for one exact StageID. stage_name and folder_name are the exact governed root basename.';


--
-- TOC entry 720 (class 1255 OID 24041)
...
--
-- TOC entry 534 (class 1255 OID 23113)
...
--
-- TOC entry 922 (class 1255 OID 24380)
-- Name: f_normalize_lor_stage_name(text, text); Type: FUNCTION; Schema: ops; Owner: msbadmin
--

CREATE FUNCTION ops.f_normalize_lor_stage_name(p_source_name text, p_stage_key text) RETURNS text
...
ALTER FUNCTION ops.f_normalize_lor_stage_name(p_source_name text, p_stage_key text) OWNER TO msbadmin;

--
-- TOC entry 510 (class 1255 OID 23559)
...
--
-- TOC entry 602 (class 1255 OID 23561)
...
--
-- TOC entry 776 (class 1255 OID 24385)
-- Name: f_record_lor_stage_authority_action(bigint, bigint, text, text, text); Type: FUNCTION; Schema: ops; Owner: msbadmin
--

CREATE FUNCTION ops.f_record_lor_stage_authority_action(p_lor_reconciliation_run_id bigint, p_lor_reconciliation_group_id bigint, p_action_type text, p_reason text, p_acted_by_application text DEFAULT NULL::text) RETURNS bigint
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'ops', 'lor_snap', 'ref'
    AS $$
DECLARE
...
ALTER FUNCTION ops.f_record_lor_stage_authority_action(p_lor_reconciliation_run_id bigint, p_lor_reconciliation_group_id bigint, p_action_type text, p_reason text, p_acted_by_application text) OWNER TO msbadmin;

--
-- TOC entry 1066 (class 1255 OID 23676)
...
--
-- TOC entry 833 (class 1255 OID 24388)
-- Name: f_set_cancelled_reconciliation_completed_at(); Type: FUNCTION; Schema: ops; Owner: msbadmin
--

CREATE FUNCTION ops.f_set_cancelled_reconciliation_completed_at() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'ops'
    AS $$
BEGIN
...
ALTER FUNCTION ops.f_set_cancelled_reconciliation_completed_at() OWNER TO msbadmin;

--
-- TOC entry 1299 (class 1255 OID 24382)
-- Name: f_stage_group_can_add_new_stage(bigint); Type: FUNCTION; Schema: ops; Owner: msbadmin
--

CREATE FUNCTION ops.f_stage_group_can_add_new_stage(p_lor_reconciliation_group_id bigint) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'ops', 'lor_snap', 'ref'
    AS $$
    WITH target AS (
...
ALTER FUNCTION ops.f_stage_group_can_add_new_stage(p_lor_reconciliation_group_id bigint) OWNER TO msbadmin;

--
-- TOC entry 6098 (class 0 OID 0)
-- Dependencies: 1299
-- Name: FUNCTION f_stage_group_can_add_new_stage(p_lor_reconciliation_group_id bigint); Type: COMMENT; Schema: ops; Owner: msbadmin
--

COMMENT ON FUNCTION ops.f_stage_group_can_add_new_stage(p_lor_reconciliation_group_id bigint) IS 'True only when one distinct new StageID has complete frozen candidate evidence and exactly one governed Google Drive Stage/Sub-stage root in that reconciliation import.';


--
-- TOC entry 1318 (class 1255 OID 24381)
-- Name: f_stage_group_can_approve_change(bigint); Type: FUNCTION; Schema: ops; Owner: msbadmin
--

CREATE FUNCTION ops.f_stage_group_can_approve_change(p_lor_reconciliation_group_id bigint) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
...
ALTER FUNCTION ops.f_stage_group_can_approve_change(p_lor_reconciliation_group_id bigint) OWNER TO msbadmin;

--
-- TOC entry 945 (class 1255 OID 23675)
...
--
-- TOC entry 686 (class 1255 OID 24454)
-- Name: f_stage_group_has_only_accepted_binding_keys(bigint); Type: FUNCTION; Schema: ops; Owner: msbadmin
--

CREATE FUNCTION ops.f_stage_group_has_only_accepted_binding_keys(p_lor_reconciliation_group_id bigint) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'ops', 'ref'
    AS $$
    SELECT
...
ALTER FUNCTION ops.f_stage_group_has_only_accepted_binding_keys(p_lor_reconciliation_group_id bigint) OWNER TO msbadmin;

--
-- TOC entry 1280 (class 1255 OID 24539)
-- Name: f_stage_group_new_stage_key(bigint); Type: FUNCTION; Schema: ops; Owner: msbadmin
--

CREATE FUNCTION ops.f_stage_group_new_stage_key(p_lor_reconciliation_group_id bigint) RETURNS text
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'ops', 'ref'
    AS $$
    WITH evidence AS (
...
ALTER FUNCTION ops.f_stage_group_new_stage_key(p_lor_reconciliation_group_id bigint) OWNER TO msbadmin;

--
-- TOC entry 852 (class 1255 OID 23557)
...
COMMENT ON FUNCTION ops.f_start_lor_display_reconciliation(p_started_by_application text) IS 'Creates a new independent evaluation of the current completed ingest. SPARE/PHANTOM candidates are isolated from physical identity components and groups; older review-stage attempts are superseded with preserved audit evidence.';


--
-- TOC entry 551 (class 1255 OID 23658)
...
--
-- TOC entry 777 (class 1255 OID 24053)
...
--
-- TOC entry 560 (class 1255 OID 24052)
...
COMMENT ON FUNCTION ops.f_sync_lor_reconciliation_effective_counters(p_lor_reconciliation_run_id bigint) IS 'Synchronizes one run counters and decision-state readiness from effective logical-group state; never performs promotion.';


--
-- TOC entry 1253 (class 1255 OID 24537)
-- Name: f_sync_lor_reconciliation_readiness_after_action(); Type: FUNCTION; Schema: ops; Owner: msbadmin
--

CREATE FUNCTION ops.f_sync_lor_reconciliation_readiness_after_action() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'ops'
    AS $$
DECLARE
...
ALTER FUNCTION ops.f_sync_lor_reconciliation_readiness_after_action() OWNER TO msbadmin;

--
-- TOC entry 6112 (class 0 OID 0)
-- Dependencies: 1253
-- Name: FUNCTION f_sync_lor_reconciliation_readiness_after_action(); Type: COMMENT; Schema: ops; Owner: msbadmin
--

COMMENT ON FUNCTION ops.f_sync_lor_reconciliation_readiness_after_action() IS 'Refreshes an open run lifecycle after any persisted operator or automatic action; skips PREFLIGHT while groups are still forming.';


--
-- TOC entry 1166 (class 1255 OID 23852)
...
--
-- TOC entry 1174 (class 1255 OID 24278)
...
--
-- TOC entry 1285 (class 1255 OID 23850)
...
--
-- TOC entry 575 (class 1255 OID 24043)
...
--
-- TOC entry 855 (class 1255 OID 18866)
...
--
-- TOC entry 1128 (class 1255 OID 19496)
...
--
-- TOC entry 597 (class 1255 OID 19544)
...
--
-- TOC entry 1022 (class 1255 OID 19554)
...
--
-- TOC entry 1203 (class 1255 OID 19110)
...
--
-- TOC entry 1003 (class 1255 OID 19175)
...
--
-- TOC entry 600 (class 1255 OID 19297)
...
--
-- TOC entry 784 (class 1255 OID 19555)
...
--
-- TOC entry 880 (class 1255 OID 19301)
...
--
-- TOC entry 785 (class 1255 OID 19292)
...
--
-- TOC entry 937 (class 1255 OID 19560)
...
--
-- TOC entry 654 (class 1255 OID 19574)
...
--
-- TOC entry 993 (class 1255 OID 24141)
...
--
-- TOC entry 1097 (class 1255 OID 24311)
-- Name: trg_copy_lor_authority_chain(); Type: FUNCTION; Schema: ops; Owner: msbadmin
--

CREATE FUNCTION ops.trg_copy_lor_authority_chain() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'ops', 'lor_snap'
    AS $$
BEGIN
...
ALTER FUNCTION ops.trg_copy_lor_authority_chain() OWNER TO msbadmin;

--
-- TOC entry 1206 (class 1255 OID 23510)
...
--
-- TOC entry 1317 (class 1255 OID 23942)
...
--
-- TOC entry 1250 (class 1255 OID 17175)
...
--
-- TOC entry 542 (class 1255 OID 25057)
...
COMMENT ON PROCEDURE ref.p1_promote_stage_from_reconciliation(IN p_lor_reconciliation_run_id bigint) IS 'Reconciliation-gated P1. Preserves migration-0039 Stage authority behavior and synchronizes an existing Stage/Sub-stage folder_path only from one exact frozen governed LOR root that matches permanent Stage identity.';


--
-- TOC entry 533 (class 1255 OID 23664)
-- Name: p1_promote_stage_from_reconciliation_before_0032(bigint); Type: PROCEDURE; Schema: ref; Owner: msbadmin
--

CREATE PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0032(IN p_lor_reconciliation_run_id bigint)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'ops', 'lor_snap', 'ref'
    AS $$
DECLARE
...
ALTER PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0032(IN p_lor_reconciliation_run_id bigint) OWNER TO msbadmin;

--
-- TOC entry 6141 (class 0 OID 0)
-- Dependencies: 533
-- Name: PROCEDURE p1_promote_stage_from_reconciliation_before_0032(IN p_lor_reconciliation_run_id bigint); Type: COMMENT; Schema: ref; Owner: msbadmin
--

COMMENT ON PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0032(IN p_lor_reconciliation_run_id bigint) IS 'Internal reconciliation-gated P1. Promotes approved frozen stage metadata except where explicitly preserved, binds all approved LOR identities, never selects an ingest, and never deletes stages.';


--
-- TOC entry 723 (class 1255 OID 24387)
-- Name: p1_promote_stage_from_reconciliation_before_0033(bigint); Type: PROCEDURE; Schema: ref; Owner: msbadmin
--

CREATE PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0033(IN p_lor_reconciliation_run_id bigint)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'ops', 'lor_snap', 'ref'
    AS $$
DECLARE
...
ALTER PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0033(IN p_lor_reconciliation_run_id bigint) OWNER TO msbadmin;

--
-- TOC entry 6143 (class 0 OID 0)
-- Dependencies: 723
-- Name: PROCEDURE p1_promote_stage_from_reconciliation_before_0033(IN p_lor_reconciliation_run_id bigint); Type: COMMENT; Schema: ref; Owner: msbadmin
--

COMMENT ON PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0033(IN p_lor_reconciliation_run_id bigint) IS 'Reconciliation-gated P1. Adds explicitly approved unambiguous new stages, then delegates existing-stage metadata/binding promotion to the preserved implementation.';


--
-- TOC entry 740 (class 1255 OID 24457)
-- Name: p1_promote_stage_from_reconciliation_before_0040(bigint); Type: PROCEDURE; Schema: ref; Owner: msbadmin
--

CREATE PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0040(IN p_lor_reconciliation_run_id bigint)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'ops', 'lor_snap', 'ref'
    AS $$
DECLARE
...
ALTER PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0040(IN p_lor_reconciliation_run_id bigint) OWNER TO msbadmin;

--
-- TOC entry 6145 (class 0 OID 0)
-- Dependencies: 740
-- Name: PROCEDURE p1_promote_stage_from_reconciliation_before_0040(IN p_lor_reconciliation_run_id bigint); Type: COMMENT; Schema: ref; Owner: msbadmin
--

COMMENT ON PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0040(IN p_lor_reconciliation_run_id bigint) IS 'Reconciliation-gated P1. New Stage/Sub-stage rows require exactly one frozen governed Drive root and store that exact root basename as both stage_name and folder_name.';


--
-- TOC entry 970 (class 1255 OID 18341)
...
--
-- TOC entry 646 (class 1255 OID 23688)
...
COMMENT ON PROCEDURE ref.p2_promote_display_from_reconciliation(IN p_lor_reconciliation_run_id bigint) IS 'Internal reconciliation-gated P2. Resolves P1-created stages by approved source StageID, refuses unresolved stage assignments, preserves display_id and production-owned metadata, and applies only approved atomic groups. Canonical revision 2026-08-17-stage-safe-p2-v2.';


--
-- TOC entry 1227 (class 1255 OID 18571)
...
--
-- TOC entry 1039 (class 1255 OID 23804)
...
--
-- TOC entry 592 (class 1255 OID 23806)
...
--
-- TOC entry 576 (class 1255 OID 19143)
...
--
-- TOC entry 1304 (class 1255 OID 19141)
...
--
-- TOC entry 1256 (class 1255 OID 19173)
...
--
-- TOC entry 909 (class 1255 OID 19111)
...
--
-- TOC entry 753 (class 1255 OID 16722)
...
--
-- TOC entry 994 (class 1255 OID 19847)
...
--
-- TOC entry 1001 (class 1255 OID 19299)
...
BEGIN
    /*
      Keep ops.test_session.container_search_helper synchronized with
      ref.container.description.

      This function fires AFTER a container description changes.

      Actor attribution is carried forward from the originating
      ref.container update so the downstream ops.test_session audit
      trigger preserves the actual user instead of falling back to
      the shared Directus database login (directus_app).

      PostgreSQL remains responsible for updated_at through the
      standard ref.set_actor_on_update() trigger on ops.test_session.
    */

    UPDATE ops.test_session AS ts
       SET container_search_helper = LEFT(NEW.description, 20),
           updated_by = NEW.updated_by,
           updated_by_person_id = NEW.updated_by_person_id
...
--
-- TOC entry 1255 (class 1255 OID 24168)
...
--
-- TOC entry 623 (class 1255 OID 24166)
...
--
-- TOC entry 1191 (class 1255 OID 18154)
...
--
-- TOC entry 1085 (class 1255 OID 24164)
...
--
-- TOC entry 944 (class 1255 OID 25518)
-- Name: validate_controller_lor_configuration(); Type: FUNCTION; Schema: ref; Owner: msbadmin
--

CREATE FUNCTION ref.validate_controller_lor_configuration() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_capacity smallint;
...
ALTER FUNCTION ref.validate_controller_lor_configuration() OWNER TO msbadmin;

--
-- TOC entry 603 (class 1255 OID 25520)
-- Name: validate_controller_model_uid_capacity(); Type: FUNCTION; Schema: ref; Owner: msbadmin
--

CREATE FUNCTION ref.validate_controller_model_uid_capacity() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
...
ALTER FUNCTION ref.validate_controller_model_uid_capacity() OWNER TO msbadmin;

--
-- TOC entry 1220 (class 1255 OID 20043)
...
--
-- TOC entry 494 (class 1255 OID 17172)
...
--
-- TOC entry 1296 (class 1255 OID 20086)
...
--
-- TOC entry 822 (class 1255 OID 20097)
...
--
-- TOC entry 1063 (class 1255 OID 17139)
...
--
-- TOC entry 292 (class 1259 OID 16821)
...
--
-- TOC entry 301 (class 1259 OID 17051)
...
CREATE TABLE ref.display (
    ...
    label_print_last_at_cached timestamp with time zone,
    label_print_last_by_cached_id integer,
    label_template_id integer DEFAULT 1 NOT NULL
);
...
-- Dependencies: 301
-- Name: COLUMN display.label_template_id; Type: COMMENT; Schema: ref; Owner: msbadmin
--

COMMENT ON COLUMN ref.display.label_template_id IS 'Physical label template assigned to this Display. References ref.label_template.';


--
-- TOC entry 267 (class 1259 OID 16457)
...
-- Dependencies: 267
-- Name: COLUMN dmx_channels.raw_prop_id; Type: COMMENT; Schema: lor_snap; Owner: msbadmin
--

COMMENT ON COLUMN lor_snap.dmx_channels.raw_prop_id IS 'Originating raw LOR PropClass.id for this DMX Channel Grid Row. Source wiring provenance only; not permanent Display or controller identity and intentionally not foreign-keyed to lor_snap.props.';


--
-- TOC entry 6199 (class 0 OID 0)
-- Dependencies: 267
-- Name: COLUMN dmx_channels.channel_name; Type: COMMENT; Schema: lor_snap; Owner: msbadmin
--

COMMENT ON COLUMN lor_snap.dmx_channels.channel_name IS 'Originating LOR PropClass.Name (Channel Name) that supplied this DMX Channel Grid Row.';


--
-- TOC entry 6200 (class 0 OID 0)
-- Dependencies: 267
-- Name: COLUMN dmx_channels.channel_grid_row_number; Type: COMMENT; Schema: lor_snap; Owner: msbadmin
--

COMMENT ON COLUMN lor_snap.dmx_channels.channel_grid_row_number IS '1-based serialized Channel Grid Row Number local to the originating PropClass. Restarts for each source PropClass; gaps may exist when a nonblank serialized row is invalid and therefore not materialized.';


--
-- TOC entry 263 (class 1259 OID 16391)
...
CREATE TABLE lor_snap.import_run (
    ...
    parser_run_mode text,
    source_lor_version text,
    parser_sha256 text,
    source_manifest_sha256 text,
    compatibility_manifest_sha256 text,
    parser_validation_status text,
    parser_validation_detail text,
    source_sqlite_sha256 text,
    CONSTRAINT ck_import_run_compatibility_manifest_sha256 CHECK (((compatibility_manifest_sha256 IS NULL) OR (compatibility_manifest_sha256 ~ '^[0-9a-f]{64}$'::text))),
    CONSTRAINT ck_import_run_parser_run_mode CHECK (((parser_run_mode IS NULL) OR (parser_run_mode = ANY (ARRAY['PRODUCTION'::text, 'VERSION_CHECK'::text, 'TEST'::text])))),
    CONSTRAINT ck_import_run_parser_sha256 CHECK (((parser_sha256 IS NULL) OR (parser_sha256 ~ '^[0-9a-f]{64}$'::text))),
    CONSTRAINT ck_import_run_parser_validation_status CHECK (((parser_validation_status IS NULL) OR (parser_validation_status = ANY (ARRAY['PASSED'::text, 'FAILED'::text, 'PENDING'::text])))),
    CONSTRAINT ck_import_run_source_manifest_sha256 CHECK (((source_manifest_sha256 IS NULL) OR (source_manifest_sha256 ~ '^[0-9a-f]{64}$'::text))),
    CONSTRAINT ck_import_run_source_sqlite_sha256 CHECK (((source_sqlite_sha256 IS NULL) OR (source_sqlite_sha256 ~ '^[0-9a-f]{64}$'::text)))
);
...
-- Dependencies: 263
-- Name: COLUMN import_run.source_lor_version; Type: COMMENT; Schema: lor_snap; Owner: msbadmin
--

COMMENT ON COLUMN lor_snap.import_run.source_lor_version IS 'Operator-declared Light-O-Rama version that exported the approved preview folder.';


--
-- TOC entry 6203 (class 0 OID 0)
-- Dependencies: 263
-- Name: COLUMN import_run.source_manifest_sha256; Type: COMMENT; Schema: lor_snap; Owner: msbadmin
--

COMMENT ON COLUMN lor_snap.import_run.source_manifest_sha256 IS 'SHA-256 of the ordered .lorprev filename/file-hash manifest recorded by the parser.';


--
-- TOC entry 6204 (class 0 OID 0)
-- Dependencies: 263
-- Name: COLUMN import_run.compatibility_manifest_sha256; Type: COMMENT; Schema: lor_snap; Owner: msbadmin
--

COMMENT ON COLUMN lor_snap.import_run.compatibility_manifest_sha256 IS 'SHA-256 of the approved complete XML compatibility manifest used for the parser run.';


--
-- TOC entry 6205 (class 0 OID 0)
-- Dependencies: 263
-- Name: COLUMN import_run.source_sqlite_sha256; Type: COMMENT; Schema: lor_snap; Owner: msbadmin
--

COMMENT ON COLUMN lor_snap.import_run.source_sqlite_sha256 IS 'SHA-256 of the exact operator-reviewed SQLite artifact accepted by ingest.';


--
-- TOC entry 262 (class 1259 OID 16390)
...
--
-- TOC entry 264 (class 1259 OID 16400)
...
--
-- TOC entry 265 (class 1259 OID 16414)
...
--
-- TOC entry 266 (class 1259 OID 16433)
...
--
-- TOC entry 268 (class 1259 OID 16479)
...
--
-- TOC entry 272 (class 1259 OID 16497)
...
-- Dependencies: 272
-- Name: VIEW v_current_dmx_channels; Type: COMMENT; Schema: lor_snap; Owner: msbadmin
--

COMMENT ON VIEW lor_snap.v_current_dmx_channels IS 'Current imported DMX rows. prop_id remains the canonical Display-master parser relationship; raw_prop_id/channel_name/channel_grid_row_number preserve V7.0.11 originating source-row detail. Historical pre-V7.0.11 snapshots may contain NULL source-detail values.';


--
-- TOC entry 269 (class 1259 OID 16483)
...
--
-- TOC entry 270 (class 1259 OID 16487)
...
--
-- TOC entry 271 (class 1259 OID 16492)
...
--
-- TOC entry 273 (class 1259 OID 16509)
...
--
-- TOC entry 274 (class 1259 OID 16514)
...
--
-- TOC entry 275 (class 1259 OID 16518)
...
--
-- TOC entry 276 (class 1259 OID 16523)
...
--
-- TOC entry 277 (class 1259 OID 16528)
...
--
-- TOC entry 278 (class 1259 OID 16532)
...
--
-- TOC entry 426 (class 1259 OID 23021)
...
--
-- TOC entry 425 (class 1259 OID 23011)
...
--
-- TOC entry 279 (class 1259 OID 16548)
...
--
-- TOC entry 280 (class 1259 OID 16553)
...
--
-- TOC entry 281 (class 1259 OID 16558)
...
--
-- TOC entry 282 (class 1259 OID 16563)
...
--
-- TOC entry 283 (class 1259 OID 16568)
...
--
-- TOC entry 428 (class 1259 OID 23042)
...
--
-- TOC entry 427 (class 1259 OID 23038)
...
--
-- TOC entry 430 (class 1259 OID 23103)
...
--
-- TOC entry 429 (class 1259 OID 23098)
 ...
 WITH background_rows AS (
        ...
        UNION ALL
         ...
         SELECT source_rows.import_run_id,
            ...
            (count(*) FILTER (WHERE ((NOT source_rows.is_spare) AND (NOT source_rows.is_phantom))))::integer AS lor_uuid_row_count,
            (count(DISTINCT source_rows.display_name_normalized) FILTER (WHERE ((NOT source_rows.is_spare) AND (NOT source_rows.is_phantom))))::integer AS lor_uuid_name_count
           FROM source_rows
          GROUP BY source_rows.import_run_id, source_rows.lor_prop_id
        ), name_counts AS (
         SELECT source_rows.import_run_id,
            source_rows.display_name_normalized,
            (count(DISTINCT source_rows.lor_prop_id) FILTER (WHERE ((NOT source_rows.is_spare) AND (NOT source_rows.is_phantom))))::integer AS lor_name_uuid_count
           FROM source_rows
...
--
-- TOC entry 309 (class 1259 OID 17187)
...
--
-- TOC entry 417 (class 1259 OID 20710)
...
--
-- TOC entry 416 (class 1259 OID 20709)
...
--
-- TOC entry 419 (class 1259 OID 20722)
...
--
-- TOC entry 418 (class 1259 OID 20721)
...
--
-- TOC entry 410 (class 1259 OID 20611)
...
--
-- TOC entry 409 (class 1259 OID 20610)
...
--
-- TOC entry 413 (class 1259 OID 20675)
...
--
-- TOC entry 412 (class 1259 OID 20674)
...
--
-- TOC entry 415 (class 1259 OID 20687)
...
--
-- TOC entry 414 (class 1259 OID 20686)
...
--
-- TOC entry 408 (class 1259 OID 20591)
...
--
-- TOC entry 407 (class 1259 OID 20590)
...
--
-- TOC entry 313 (class 1259 OID 17288)
...
--
-- TOC entry 312 (class 1259 OID 17287)
...
--
-- TOC entry 445 (class 1259 OID 23486)
...
--
-- TOC entry 447 (class 1259 OID 23513)
...
--
-- TOC entry 446 (class 1259 OID 23512)
...
--
-- TOC entry 433 (class 1259 OID 23184)
...
--
-- TOC entry 432 (class 1259 OID 23183)
...
--
-- TOC entry 444 (class 1259 OID 23485)
...
--
-- TOC entry 443 (class 1259 OID 23453)
...
--
-- TOC entry 442 (class 1259 OID 23452)
...
--
-- TOC entry 441 (class 1259 OID 23429)
...
--
-- TOC entry 440 (class 1259 OID 23428)
...
--
-- TOC entry 449 (class 1259 OID 23539)
...
--
-- TOC entry 448 (class 1259 OID 23538)
...
--
-- TOC entry 439 (class 1259 OID 23405)
...
--
-- TOC entry 438 (class 1259 OID 23404)
...
--
-- TOC entry 459 (class 1259 OID 23717)
...
--
-- TOC entry 458 (class 1259 OID 23716)
...
--
-- TOC entry 461 (class 1259 OID 23750)
...
--
-- TOC entry 460 (class 1259 OID 23749)
...
--
-- TOC entry 466 (class 1259 OID 23893)
...
--
-- TOC entry 465 (class 1259 OID 23892)
...
--
-- TOC entry 464 (class 1259 OID 23877)
...
COMMENT ON TABLE ops.lor_reconciliation_source_run IS 'Immutable typed copy of complete ingest provenance, including the LOR parser-to-SQLite authority chain.';


--
-- TOC entry 468 (class 1259 OID 23909)
...
--
-- TOC entry 467 (class 1259 OID 23908)
...
--
-- TOC entry 456 (class 1259 OID 23615)
...
--
-- TOC entry 455 (class 1259 OID 23614)
...
--
-- TOC entry 311 (class 1259 OID 17257)
...
--
-- TOC entry 310 (class 1259 OID 17256)
...
--
-- TOC entry 411 (class 1259 OID 20635)
...
--
-- TOC entry 431 (class 1259 OID 23108)
...
CREATE VIEW ops.v_lor_display_reconciliation AS
 WITH production AS (
         ...
         SELECT o.import_run_id,
          ...
          GROUP BY o.import_run_id, o.lor_prop_id, o.display_name_normalized
        ), candidate_rows AS (
         SELECT swm.import_run_id,
           ...
           FROM (source_with_matches swm
             LEFT JOIN occurrence_summary os ON (((os.import_run_id = swm.import_run_id) AND (os.lor_prop_id = swm.lor_prop_id) AND (NOT (os.display_name_normalized IS DISTINCT FROM swm.display_name_normalized)))))
        ), candidate_output AS (
         SELECT cr.import_run_id,
            cr.lor_prop_id,
            cr.lor_display_name,
...
COMMENT ON VIEW ops.v_lor_display_reconciliation IS 'Live bidirectional display preflight by explicit import_run_id. SPARE/PHANTOM evidence cannot create a physical duplicate or contribute locations to a renamed in-service Display. Exact matches pass automatically; physical identity, status, duplicate, and missing-display discrepancies block.';


--
-- TOC entry 470 (class 1259 OID 24036)
...
--
-- TOC entry 450 (class 1259 OID 23562)
...
CREATE VIEW ops.v_lor_reconciliation_group_review AS
 WITH latest_action AS (
         ...
         SELECT g_1.lor_reconciliation_group_id,
            ops.f_stage_group_has_only_accepted_binding_keys(g_1.lor_reconciliation_group_id) AS all_keys_accepted
           FROM ops.lor_reconciliation_group g_1
          WHERE (g_1.entity_type = 'STAGE'::text)
        )
 SELECT g.lor_reconciliation_group_id,
    ...
    (g.decision_required AND (NOT COALESCE(abk.all_keys_accepted, false))) AS decision_required,
    (((
        CASE
            WHEN COALESCE(abk.all_keys_accepted, false) THEN ARRAY[]::text[]
            ELSE g.allowed_action_types
        END ||
        CASE
            WHEN ops.f_stage_group_can_preserve_existing_metadata(g.lor_reconciliation_group_id) THEN ARRAY['PRESERVE_EXISTING_STAGE_METADATA'::text]
            ELSE ARRAY[]::text[]
        END) ||
        CASE
            WHEN ops.f_stage_group_can_approve_change(g.lor_reconciliation_group_id) THEN ARRAY['APPROVE_STAGE_CHANGE'::text]
            ELSE ARRAY[]::text[]
        END) ||
        CASE
            WHEN ops.f_stage_group_can_add_new_stage(g.lor_reconciliation_group_id) THEN ARRAY['ADD_NEW_STAGE'::text]
            ELSE ARRAY[]::text[]
        END) AS allowed_action_types,
        CASE
            WHEN COALESCE(abk.all_keys_accepted, false) THEN 'Stable LOR bindings retain previously approved source StageIDs for this permanent stage.'::text
            ELSE g.operator_message
        END AS operator_message,
    ...
    la.acted_by_application,
        CASE
            ...
            WHEN COALESCE(abk.all_keys_accepted, false) THEN 'AUTO_APPROVED'::text
   ...
   FROM ((ops.lor_reconciliation_group g
     ...
     LEFT JOIN accepted_binding_keys abk ON ((abk.lor_reconciliation_group_id = g.lor_reconciliation_group_id)));
...
COMMENT ON VIEW ops.v_lor_reconciliation_group_review IS 'One row per logical group. Safe stage approval actions are derived from complete frozen evidence; contradictory stage groups retain fallback actions only.';


--
-- TOC entry 352 (class 1259 OID 18094)
...
--
-- TOC entry 451 (class 1259 OID 23567)
...
--
-- TOC entry 463 (class 1259 OID 23800)
...
--
-- TOC entry 462 (class 1259 OID 23796)
...
--
-- TOC entry 457 (class 1259 OID 23659)
...
CREATE VIEW ops.v_lor_reconciliation_operator_stage_review AS
 SELECT gr.lor_reconciliation_run_id,
   ...
   FROM ((ops.v_lor_reconciliation_group_review gr
     ...
     LEFT JOIN LATERAL ( SELECT r.folder_path,
            r.folder_name,
            r.stage_name,
            r.evidence_count
           FROM ops.f_lor_governed_stage_roots(c.import_run_id, c.source_stage_key) r(folder_path, folder_name, stage_name, evidence_count)
          WHERE (( SELECT count(*) AS count
                   FROM ops.f_lor_governed_stage_roots(c.import_run_id, c.source_stage_key) f_lor_governed_stage_roots(folder_path, folder_name, stage_name, evidence_count)) = 1)) root ON (true))
...
-- Dependencies: 457
-- Name: VIEW v_lor_reconciliation_operator_stage_review; Type: COMMENT; Schema: ops; Owner: msbadmin
--

COMMENT ON VIEW ops.v_lor_reconciliation_operator_stage_review IS 'Operator Stage review. When one governed Drive root is frozen for a source StageID, proposed Stage/folder names are the exact governed root basename.';


--
-- TOC entry 452 (class 1259 OID 23572)
...
--
-- TOC entry 469 (class 1259 OID 23927)
...
--
-- TOC entry 371 (class 1259 OID 18813)
...
--
-- TOC entry 372 (class 1259 OID 18869)
...
--
-- TOC entry 373 (class 1259 OID 18879)
...
--
-- TOC entry 376 (class 1259 OID 18939)
...
--
-- TOC entry 387 (class 1259 OID 19131)
...
--
-- TOC entry 382 (class 1259 OID 19008)
...
--
-- TOC entry 471 (class 1259 OID 24264)
...
--
-- TOC entry 362 (class 1259 OID 18484)
...
--
-- TOC entry 381 (class 1259 OID 19007)
...
--
-- TOC entry 384 (class 1259 OID 19044)
...
--
-- TOC entry 383 (class 1259 OID 19043)
...
--
-- TOC entry 361 (class 1259 OID 18483)
...
--
-- TOC entry 392 (class 1259 OID 19212)
...
--
-- TOC entry 391 (class 1259 OID 19211)
...
--
-- TOC entry 389 (class 1259 OID 19207)
...
--
-- TOC entry 356 (class 1259 OID 18282)
...
--
-- TOC entry 388 (class 1259 OID 19205)
...
--
-- TOC entry 375 (class 1259 OID 18938)
...
--
-- TOC entry 393 (class 1259 OID 19295)
...
--
-- TOC entry 481 (class 1259 OID 25373)
-- Name: controller; Type: TABLE; Schema: ref; Owner: msbadmin
--

CREATE TABLE ref.controller (
    controller_id bigint NOT NULL,
    controller_model_id integer NOT NULL,
    controller_status_id integer NOT NULL,
    hardware_revision text,
    installed_firmware_version_id integer,
    firmware_verification_state text DEFAULT 'UNKNOWN'::text NOT NULL,
    firmware_verified_at timestamp with time zone,
    ...
    verification_state text DEFAULT 'ENGINEERING_ACCEPTED'::text NOT NULL,
    notes text,
    label_required boolean DEFAULT true NOT NULL,
    print_label boolean DEFAULT false NOT NULL,
    label_print_count_cached integer DEFAULT 0 NOT NULL,
    ...
    management_ip inet,
    programmed_config_verification_state text DEFAULT 'UNKNOWN'::text NOT NULL,
    programmed_config_verified_at timestamp with time zone,
    programmed_config_verified_by_person_id integer,
    programmed_config_source_note text,
    lor_uid_end smallint GENERATED ALWAYS AS (
CASE
    WHEN ((lor_uid_start IS NULL) OR (lor_uid_count IS NULL)) THEN NULL::smallint
    ELSE (((lor_uid_start + lor_uid_count) - 1))::smallint
END) STORED,
    CONSTRAINT ck_controller_firmware_verification_state CHECK ((firmware_verification_state = ANY (ARRAY['UNKNOWN'::text, 'RECORDED_UNVERIFIED'::text, 'VERIFIED'::text]))),
    CONSTRAINT ck_controller_label_print_count CHECK ((label_print_count_cached >= 0)),
    CONSTRAINT ck_controller_lor_config_all_or_none CHECK ((((lor_network IS NULL) AND (lor_uid_start IS NULL) AND (lor_uid_count IS NULL)) OR ((NULLIF(btrim(lor_network), ''::text) IS NOT NULL) AND (lor_uid_start IS NOT NULL) AND (lor_uid_count IS NOT NULL)))),
    CONSTRAINT ck_controller_lor_uid_count CHECK (((lor_uid_count IS NULL) OR ((lor_uid_count >= 1) AND (lor_uid_count <= 240)))),
    CONSTRAINT ck_controller_lor_uid_end CHECK (((lor_uid_end IS NULL) OR ((lor_uid_end >= 1) AND (lor_uid_end <= 240)))),
    CONSTRAINT ck_controller_lor_uid_start CHECK (((lor_uid_start IS NULL) OR ((lor_uid_start >= 1) AND (lor_uid_start <= 240)))),
    CONSTRAINT ck_controller_programmed_config_state CHECK ((programmed_config_verification_state = ANY (ARRAY['UNKNOWN'::text, 'RECORDED_UNVERIFIED'::text, 'VERIFIED'::text]))),
    CONSTRAINT ck_controller_verification_state CHECK ((verification_state = ANY (ARRAY['ENGINEERING_ACCEPTED'::text, 'FIELD_VERIFICATION_REQUIRED'::text, 'PHYSICALLY_VERIFIED'::text]))),
    CONSTRAINT ck_controller_year_deployed CHECK (((year_deployed IS NULL) OR ((year_deployed >= 1980) AND (year_deployed <= 2100))))
);


ALTER TABLE ref.controller OWNER TO msbadmin;

--
-- TOC entry 6355 (class 0 OID 0)
-- Dependencies: 481
-- Name: COLUMN controller.lor_network; Type: COMMENT; Schema: ref; Owner: msbadmin
--

COMMENT ON COLUMN ref.controller.lor_network IS 'Current programmed LOR network; mutable configuration, not controller identity.';


--
-- TOC entry 6356 (class 0 OID 0)
-- Dependencies: 481
-- Name: COLUMN controller.lor_uid_start; Type: COMMENT; Schema: ref; Owner: msbadmin
--

COMMENT ON COLUMN ref.controller.lor_uid_start IS 'Current first LOR Unit ID stored numerically 1..240; application renders hexadecimal.';


--
-- TOC entry 6357 (class 0 OID 0)
-- Dependencies: 481
-- Name: COLUMN controller.lor_uid_count; Type: COMMENT; Schema: ref; Owner: msbadmin
--

COMMENT ON COLUMN ref.controller.lor_uid_count IS 'Number of contiguous LOR Unit IDs currently programmed; operator enters ordinary decimal count.';


--
-- TOC entry 6358 (class 0 OID 0)
-- Dependencies: 481
-- Name: COLUMN controller.management_ip; Type: COMMENT; Schema: ref; Owner: msbadmin
--

COMMENT ON COLUMN ref.controller.management_ip IS 'Current management IP when applicable; mutable configuration, not controller identity.';


--
-- TOC entry 6359 (class 0 OID 0)
-- Dependencies: 481
-- Name: COLUMN controller.lor_uid_end; Type: COMMENT; Schema: ref; Owner: msbadmin
--

COMMENT ON COLUMN ref.controller.lor_uid_end IS 'Calculated inclusive ending Unit ID from First UID + UID Count - 1.';


--
-- TOC entry 480 (class 1259 OID 25372)
-- Name: controller_controller_id_seq; Type: SEQUENCE; Schema: ref; Owner: msbadmin
--

ALTER TABLE ref.controller ALTER COLUMN controller_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME ref.controller_controller_id_seq
    START WITH 1001
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 482 (class 1259 OID 25428)
-- Name: controller_display; Type: TABLE; Schema: ref; Owner: msbadmin
--

CREATE TABLE ref.controller_display (
    controller_id bigint NOT NULL,
    display_id bigint NOT NULL,
...
ALTER TABLE ref.controller_display OWNER TO msbadmin;

--
-- TOC entry 484 (class 1259 OID 25455)
-- Name: controller_firmware_history; Type: TABLE; Schema: ref; Owner: msbadmin
--

CREATE TABLE ref.controller_firmware_history (
    controller_firmware_history_id bigint NOT NULL,
    controller_id bigint NOT NULL,
    controller_firmware_version_id integer NOT NULL,
    firmware_recorded_at timestamp with time zone DEFAULT now() NOT NULL,
    ...
    created_by_person_id integer,
    updated_by_person_id integer,
    CONSTRAINT ck_controller_firmware_history_state CHECK ((verification_state = ANY (ARRAY['RECORDED_UNVERIFIED'::text, 'VERIFIED'::text])))
);


ALTER TABLE ref.controller_firmware_history OWNER TO msbadmin;

--
-- TOC entry 483 (class 1259 OID 25454)
-- Name: controller_firmware_history_controller_firmware_history_id_seq; Type: SEQUENCE; Schema: ref; Owner: msbadmin
--

ALTER TABLE ref.controller_firmware_history ALTER COLUMN controller_firmware_history_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME ref.controller_firmware_history_controller_firmware_history_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 477 (class 1259 OID 25278)
-- Name: controller_firmware_version; Type: TABLE; Schema: ref; Owner: msbadmin
--

CREATE TABLE ref.controller_firmware_version (
    controller_firmware_version_id integer NOT NULL,
    controller_model_id integer NOT NULL,
    firmware_version text NOT NULL,
    source_note text,
    is_current_recommended boolean DEFAULT false NOT NULL,
    reference_url text,
    notes text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    created_by text DEFAULT CURRENT_USER NOT NULL,
...
ALTER TABLE ref.controller_firmware_version OWNER TO msbadmin;

--
-- TOC entry 476 (class 1259 OID 25277)
-- Name: controller_firmware_version_controller_firmware_version_id_seq; Type: SEQUENCE; Schema: ref; Owner: msbadmin
--

ALTER TABLE ref.controller_firmware_version ALTER COLUMN controller_firmware_version_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME ref.controller_firmware_version_controller_firmware_version_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 475 (class 1259 OID 25263)
-- Name: controller_model; Type: TABLE; Schema: ref; Owner: msbadmin
--

CREATE TABLE ref.controller_model (
    controller_model_id integer NOT NULL,
    ...
    device_family text,
    display_assignment_capable boolean DEFAULT true NOT NULL,
    ...
    created_by_person_id integer,
    updated_by_person_id integer,
    lor_uid_capacity smallint,
    lor_uid_requires_full_capacity boolean DEFAULT false NOT NULL,
    CONSTRAINT ck_controller_model_lor_uid_capacity CHECK (((lor_uid_capacity IS NULL) OR ((lor_uid_capacity >= 1) AND (lor_uid_capacity <= 240))))
);


ALTER TABLE ref.controller_model OWNER TO msbadmin;

--
-- TOC entry 6367 (class 0 OID 0)
-- Dependencies: 475
-- Name: COLUMN controller_model.lor_uid_capacity; Type: COMMENT; Schema: ref; Owner: msbadmin
--

COMMENT ON COLUMN ref.controller_model.lor_uid_capacity IS 'Maximum number of contiguous LOR Unit IDs this model may use. NULL means not applicable or not yet established.';


--
-- TOC entry 6368 (class 0 OID 0)
-- Dependencies: 475
-- Name: COLUMN controller_model.lor_uid_requires_full_capacity; Type: COMMENT; Schema: ref; Owner: msbadmin
--

COMMENT ON COLUMN ref.controller_model.lor_uid_requires_full_capacity IS 'When true, configured LOR UID Count must equal lor_uid_capacity exactly.';


--
-- TOC entry 474 (class 1259 OID 25262)
-- Name: controller_model_controller_model_id_seq; Type: SEQUENCE; Schema: ref; Owner: msbadmin
--

ALTER TABLE ref.controller_model ALTER COLUMN controller_model_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME ref.controller_model_controller_model_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 479 (class 1259 OID 25359)
-- Name: controller_status; Type: TABLE; Schema: ref; Owner: msbadmin
--

CREATE TABLE ref.controller_status (
    controller_status_id integer NOT NULL,
    controller_status_name text NOT NULL,
    description text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    created_by text DEFAULT CURRENT_USER NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
...
ALTER TABLE ref.controller_status OWNER TO msbadmin;

--
-- TOC entry 478 (class 1259 OID 25358)
-- Name: controller_status_controller_status_id_seq; Type: SEQUENCE; Schema: ref; Owner: msbadmin
--

ALTER TABLE ref.controller_status ALTER COLUMN controller_status_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME ref.controller_status_controller_status_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 396 (class 1259 OID 20326)
...
--
-- TOC entry 400 (class 1259 OID 20431)
...
--
-- TOC entry 402 (class 1259 OID 20453)
...
--
-- TOC entry 406 (class 1259 OID 20534)
...
--
-- TOC entry 404 (class 1259 OID 20476)
...
--
-- TOC entry 437 (class 1259 OID 23365)
...
--
-- TOC entry 370 (class 1259 OID 18722)
...
--
-- TOC entry 288 (class 1259 OID 16760)
...
--
-- TOC entry 374 (class 1259 OID 18907)
...
--
-- TOC entry 284 (class 1259 OID 16705)
...
--
-- TOC entry 473 (class 1259 OID 25119)
-- Name: label_template; Type: TABLE; Schema: ref; Owner: msbadmin
--
...
CREATE TABLE ref.label_template (
    ...
    updated_by text DEFAULT CURRENT_USER NOT NULL,
    updated_by_person_id bigint,
    CONSTRAINT ck_label_template_class_not_blank CHECK ((btrim(label_class) <> ''::text)),
    CONSTRAINT ck_label_template_code_not_blank CHECK ((btrim(label_template_code) <> ''::text)),
    CONSTRAINT ck_label_template_media_type_not_blank CHECK ((btrim(media_type) <> ''::text)),
    CONSTRAINT ck_label_template_media_width_positive CHECK ((media_width_mm > 0)),
    CONSTRAINT ck_label_template_name_not_blank CHECK ((btrim(label_template_name) <> ''::text)),
    CONSTRAINT ck_label_template_orientation CHECK ((label_orientation = ANY (ARRAY['HORIZONTAL'::text, 'VERTICAL'::text])))
);
...
--
-- TOC entry 472 (class 1259 OID 25118)
-- Name: label_template_label_template_id_seq; Type: SEQUENCE; Schema: ref; Owner: msbadmin
--

ALTER TABLE ref.label_template ALTER COLUMN label_template_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME ref.label_template_label_template_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 435 (class 1259 OID 23226)
...
--
-- TOC entry 436 (class 1259 OID 23251)
...
--
-- TOC entry 434 (class 1259 OID 23225)
...
--
-- TOC entry 290 (class 1259 OID 16805)
...
--
-- TOC entry 390 (class 1259 OID 19209)
...
--
-- TOC entry 298 (class 1259 OID 16973)
...
--
-- TOC entry 394 (class 1259 OID 19486)
...
--
-- TOC entry 363 (class 1259 OID 18556)
...
--
-- TOC entry 397 (class 1259 OID 20331)
...
--
-- TOC entry 401 (class 1259 OID 20438)
...
--
-- TOC entry 398 (class 1259 OID 20359)
...
--
-- TOC entry 399 (class 1259 OID 20365)
...
--
-- TOC entry 403 (class 1259 OID 20460)
...
--
-- TOC entry 405 (class 1259 OID 20510)
...
--
-- TOC entry 353 (class 1259 OID 18103)
...
--
-- TOC entry 454 (class 1259 OID 23593)
...
CREATE TABLE ref.stage_lor_binding (
    ...
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_by text DEFAULT CURRENT_USER NOT NULL,
    accepted_source_stage_key text,
...
-- Dependencies: 454
-- Name: COLUMN stage_lor_binding.accepted_source_stage_key; Type: COMMENT; Schema: ref; Owner: msbadmin
--

COMMENT ON COLUMN ref.stage_lor_binding.accepted_source_stage_key IS 'Last operator-approved source StageID for this stable LOR preview/scene binding. It may differ from the permanent stage''s canonical stage_key.';


--
-- TOC entry 453 (class 1259 OID 23592)
...
--
-- TOC entry 293 (class 1259 OID 16841)
...
--
-- TOC entry 358 (class 1259 OID 18393)
...
--
-- TOC entry 357 (class 1259 OID 18392)
...
--
-- TOC entry 287 (class 1259 OID 16746)
...
--
-- TOC entry 395 (class 1259 OID 19624)
...
--
-- TOC entry 360 (class 1259 OID 18423)
...
--
-- TOC entry 359 (class 1259 OID 18422)
...
--
-- TOC entry 378 (class 1259 OID 18962)
...
--
-- TOC entry 377 (class 1259 OID 18961)
...
--
-- TOC entry 485 (class 1259 OID 25535)
-- Name: controller_directus_collections_backup_20260831; Type: TABLE; Schema: stage; Owner: msbadmin
--

CREATE TABLE stage.controller_directus_collections_backup_20260831 (
    ...
    accountability character varying(255),
...
ALTER TABLE stage.controller_directus_collections_backup_20260831 OWNER TO msbadmin;

--
-- TOC entry 486 (class 1259 OID 25540)
-- Name: controller_directus_fields_backup_20260831; Type: TABLE; Schema: stage; Owner: msbadmin
--

CREATE TABLE stage.controller_directus_fields_backup_20260831 (
    id integer,
    collection character varying(64),
...
ALTER TABLE stage.controller_directus_fields_backup_20260831 OWNER TO msbadmin;

--
-- TOC entry 488 (class 1259 OID 25550)
-- Name: controller_directus_permissions_backup_20260831; Type: TABLE; Schema: stage; Owner: msbadmin
--

CREATE TABLE stage.controller_directus_permissions_backup_20260831 (
    id integer,
    collection character varying(64),
...
ALTER TABLE stage.controller_directus_permissions_backup_20260831 OWNER TO msbadmin;

--
-- TOC entry 487 (class 1259 OID 25545)
-- Name: controller_directus_relations_backup_20260831; Type: TABLE; Schema: stage; Owner: msbadmin
--

CREATE TABLE stage.controller_directus_relations_backup_20260831 (
    id integer,
    many_collection character varying(64),
    many_field character varying(64),
    ...
    sort_field character varying(64),
    one_deselect_action character varying(255)
);


ALTER TABLE stage.controller_directus_relations_backup_20260831 OWNER TO msbadmin;

--
-- TOC entry 302 (class 1259 OID 17088)
...
--
-- TOC entry 355 (class 1259 OID 18248)
...
--
-- TOC entry 351 (class 1259 OID 18067)
...
--
-- TOC entry 305 (class 1259 OID 17108)
...
--
-- TOC entry 367 (class 1259 OID 18688)
...
--
-- TOC entry 365 (class 1259 OID 18653)
...
--
-- TOC entry 368 (class 1259 OID 18704)
...
--
-- TOC entry 295 (class 1259 OID 16889)
...
--
-- TOC entry 297 (class 1259 OID 16968)
...
--
-- TOC entry 4992 (class 2604 OID 16394)
...
--
-- TOC entry 5155 (class 2604 OID 20713)
...
--
-- TOC entry 5158 (class 2604 OID 20725)
...
--
-- TOC entry 5146 (class 2604 OID 20614)
...
--
-- TOC entry 5150 (class 2604 OID 20678)
...
--
-- TOC entry 5153 (class 2604 OID 20690)
...
--
-- TOC entry 5142 (class 2604 OID 20594)
...
--
-- TOC entry 5060 (class 2604 OID 17291)
...
--
-- TOC entry 5049 (class 2604 OID 17260)
...
--
-- TOC entry 5084 (class 2604 OID 18487)
...
--
-- TOC entry 5010 (class 2604 OID 19208)
...
--
-- TOC entry 5069 (class 2604 OID 19206)
...
--
-- TOC entry 5024 (class 2604 OID 19210)
...
--
-- TOC entry 5062 (class 2604 OID 18188)
...
--
-- TOC entry 5074 (class 2604 OID 18396)
...
--
-- TOC entry 5079 (class 2604 OID 18426)
...
--
-- TOC entry 5098 (class 2604 OID 18691)
...
--
-- TOC entry 5095 (class 2604 OID 18656)
...
--
-- TOC entry 5329 (class 2606 OID 16463)
...
--
-- TOC entry 5313 (class 2606 OID 16399)
...
--
-- TOC entry 5315 (class 2606 OID 16408)
...
--
-- TOC entry 5317 (class 2606 OID 16406)
...
--
-- TOC entry 5320 (class 2606 OID 16422)
...
--
-- TOC entry 5322 (class 2606 OID 16420)
...
--
-- TOC entry 5325 (class 2606 OID 16441)
...
--
-- TOC entry 5327 (class 2606 OID 16439)
...
--
-- TOC entry 5486 (class 2606 OID 20732)
...
--
-- TOC entry 5488 (class 2606 OID 20730)
...
--
-- TOC entry 5483 (class 2606 OID 20719)
...
--
-- TOC entry 5468 (class 2606 OID 20623)
...
--
-- TOC entry 5475 (class 2606 OID 20697)
...
--
-- TOC entry 5477 (class 2606 OID 20695)
...
--
-- TOC entry 5472 (class 2606 OID 20684)
...
--
-- TOC entry 5464 (class 2606 OID 20602)
...
--
-- TOC entry 5390 (class 2606 OID 17296)
...
--
-- TOC entry 5538 (class 2606 OID 23517)
...
--
-- TOC entry 5501 (class 2606 OID 23194)
...
--
-- TOC entry 5536 (class 2606 OID 23498)
...
--
-- TOC entry 5531 (class 2606 OID 23465)
...
--
-- TOC entry 5525 (class 2606 OID 23443)
...
--
-- TOC entry 5544 (class 2606 OID 23548)
...
--
-- TOC entry 5519 (class 2606 OID 23423)
...
--
-- TOC entry 5558 (class 2606 OID 23728)
...
--
-- TOC entry 5564 (class 2606 OID 23761)
...
--
-- TOC entry 5572 (class 2606 OID 23900)
...
--
-- TOC entry 5568 (class 2606 OID 23884)
...
--
-- TOC entry 5577 (class 2606 OID 23916)
...
--
-- TOC entry 5552 (class 2606 OID 23626)
...
--
-- TOC entry 5385 (class 2606 OID 17267)
...
--
-- TOC entry 5492 (class 2606 OID 20779)
...
--
-- TOC entry 5481 (class 2606 OID 20761)
...
--
-- TOC entry 5392 (class 2606 OID 18748)
...
--
-- TOC entry 5387 (class 2606 OID 19543)
...
--
-- TOC entry 5540 (class 2606 OID 23519)
...
--
-- TOC entry 5542 (class 2606 OID 23521)
...
--
-- TOC entry 5533 (class 2606 OID 23467)
...
--
-- TOC entry 5527 (class 2606 OID 23445)
...
--
-- TOC entry 5522 (class 2606 OID 24237)
...
--
-- TOC entry 5560 (class 2606 OID 23730)
...
--
-- TOC entry 5566 (class 2606 OID 23763)
...
--
-- TOC entry 5574 (class 2606 OID 23902)
...
--
-- TOC entry 5570 (class 2606 OID 23886)
...
--
-- TOC entry 5554 (class 2606 OID 23628)
...
--
-- TOC entry 5446 (class 2606 OID 19019)
...
--
-- TOC entry 5452 (class 2606 OID 19079)
...
--
-- TOC entry 5417 (class 2606 OID 18493)
...
--
-- TOC entry 5449 (class 2606 OID 19051)
...
--
-- TOC entry 5454 (class 2606 OID 19222)
...
--
-- TOC entry 5403 (class 2606 OID 18288)
...
--
-- TOC entry 5428 (class 2606 OID 18949)
...
--
-- TOC entry 5430 (class 2606 OID 18947)
...
--
-- TOC entry 5601 (class 2606 OID 25467)
-- Name: controller_firmware_history controller_firmware_history_pkey; Type: CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_firmware_history
    ADD CONSTRAINT controller_firmware_history_pkey PRIMARY KEY (controller_firmware_history_id);


--
-- TOC entry 5587 (class 2606 OID 25289)
-- Name: controller_firmware_version controller_firmware_version_pkey; Type: CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_firmware_version
    ADD CONSTRAINT controller_firmware_version_pkey PRIMARY KEY (controller_firmware_version_id);


--
-- TOC entry 5583 (class 2606 OID 25276)
-- Name: controller_model controller_model_model_code_key; Type: CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_model
    ADD CONSTRAINT controller_model_model_code_key UNIQUE (model_code);


--
-- TOC entry 5585 (class 2606 OID 25274)
-- Name: controller_model controller_model_pkey; Type: CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_model
    ADD CONSTRAINT controller_model_pkey PRIMARY KEY (controller_model_id);


--
-- TOC entry 5597 (class 2606 OID 25392)
-- Name: controller controller_pkey; Type: CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller
    ADD CONSTRAINT controller_pkey PRIMARY KEY (controller_id);


--
-- TOC entry 5593 (class 2606 OID 25371)
-- Name: controller_status controller_status_controller_status_name_key; Type: CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_status
    ADD CONSTRAINT controller_status_controller_status_name_key UNIQUE (controller_status_name);


--
-- TOC entry 5595 (class 2606 OID 25369)
-- Name: controller_status controller_status_pkey; Type: CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_status
    ADD CONSTRAINT controller_status_pkey PRIMARY KEY (controller_status_id);


--
-- TOC entry 5370 (class 2606 OID 18845)
...
--
-- TOC entry 5341 (class 2606 OID 16773)
...
--
-- TOC entry 5343 (class 2606 OID 16771)
...
--
-- TOC entry 5426 (class 2606 OID 18913)
...
--
-- TOC entry 5331 (class 2606 OID 16716)
...
--
-- TOC entry 5368 (class 2606 OID 17034)
...
--
-- TOC entry 5579 (class 2606 OID 25139)
-- Name: label_template label_template_label_template_code_key; Type: CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.label_template
    ADD CONSTRAINT label_template_label_template_code_key UNIQUE (label_template_code);


--
-- TOC entry 5581 (class 2606 OID 25137)
-- Name: label_template label_template_pkey; Type: CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.label_template
    ADD CONSTRAINT label_template_pkey PRIMARY KEY (label_template_id);


--
-- TOC entry 5506 (class 2606 OID 23236)
...
--
-- TOC entry 5349 (class 2606 OID 16831)
...
--
-- TOC entry 5345 (class 2606 OID 16818)
...
--
-- TOC entry 5347 (class 2606 OID 16816)
...
--
-- TOC entry 5359 (class 2606 OID 16966)
...
--
-- TOC entry 5599 (class 2606 OID 25438)
-- Name: controller_display pk_controller_display; Type: CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_display
    ADD CONSTRAINT pk_controller_display PRIMARY KEY (controller_id, display_id);


--
-- TOC entry 5514 (class 2606 OID 23261)
...
--
-- TOC entry 5366 (class 2606 OID 16986)
...
--
-- TOC entry 5372 (class 2606 OID 18741)
...
--
-- TOC entry 5458 (class 2606 OID 19493)
...
--
-- TOC entry 5420 (class 2606 OID 18566)
...
--
-- TOC entry 5401 (class 2606 OID 18111)
...
--
-- TOC entry 5547 (class 2606 OID 23605)
...
--
-- TOC entry 5397 (class 2606 OID 18102)
...
--
-- TOC entry 5352 (class 2606 OID 18906)
...
--
-- TOC entry 5405 (class 2606 OID 18404)
...
--
-- TOC entry 5337 (class 2606 OID 16756)
...
--
-- TOC entry 5339 (class 2606 OID 16758)
...
--
-- TOC entry 5456 (class 2606 OID 19224)
...
--
-- TOC entry 5589 (class 2606 OID 25293)
-- Name: controller_firmware_version uq_controller_firmware_model_id_pair; Type: CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_firmware_version
    ADD CONSTRAINT uq_controller_firmware_model_id_pair UNIQUE (controller_model_id, controller_firmware_version_id);


--
-- TOC entry 5591 (class 2606 OID 25291)
-- Name: controller_firmware_version uq_controller_firmware_model_version; Type: CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_firmware_version
    ADD CONSTRAINT uq_controller_firmware_model_version UNIQUE (controller_model_id, firmware_version);


--
-- TOC entry 5333 (class 2606 OID 16718)
...
--
-- TOC entry 5335 (class 2606 OID 16720)
...
--
-- TOC entry 5354 (class 2606 OID 16854)
...
--
-- TOC entry 5516 (class 2606 OID 23263)
...
--
-- TOC entry 5508 (class 2606 OID 23240)
...
--
-- TOC entry 5510 (class 2606 OID 23238)
...
--
-- TOC entry 5361 (class 2606 OID 19130)
...
--
-- TOC entry 5374 (class 2606 OID 18734)
...
--
-- TOC entry 5399 (class 2606 OID 18163)
...
--
-- TOC entry 5376 (class 2606 OID 18843)
...
--
-- TOC entry 5409 (class 2606 OID 18434)
...
--
-- TOC entry 5433 (class 2606 OID 18973)
...
--
-- TOC entry 5424 (class 2606 OID 18697)
...
--
-- TOC entry 5441 (class 2606 OID 18987)
...
--
-- TOC entry 5422 (class 2606 OID 18662)
...
--
-- TOC entry 5318 (class 1259 OID 23350)
...
--
-- TOC entry 5323 (class 1259 OID 23351)
...
--
-- TOC entry 5496 (class 1259 OID 23034)
...
--
-- TOC entry 5497 (class 1259 OID 23037)
...
--
-- TOC entry 5498 (class 1259 OID 23036)
...
--
-- TOC entry 5499 (class 1259 OID 23035)
...
--
-- TOC entry 5493 (class 1259 OID 23031)
...
--
-- TOC entry 5494 (class 1259 OID 23033)
...
--
-- TOC entry 5495 (class 1259 OID 23032)
...
--
-- TOC entry 5489 (class 1259 OID 20743)
...
--
-- TOC entry 5490 (class 1259 OID 20781)
...
--
-- TOC entry 5484 (class 1259 OID 20720)
...
--
-- TOC entry 5469 (class 1259 OID 20629)
...
--
-- TOC entry 5470 (class 1259 OID 20630)
...
--
-- TOC entry 5478 (class 1259 OID 20708)
...
--
-- TOC entry 5479 (class 1259 OID 20762)
...
--
-- TOC entry 5473 (class 1259 OID 20685)
...
--
-- TOC entry 5465 (class 1259 OID 20793)
...
--
-- TOC entry 5466 (class 1259 OID 20609)
...
--
-- TOC entry 5534 (class 1259 OID 23509)
...
--
-- TOC entry 5528 (class 1259 OID 23483)
...
--
-- TOC entry 5529 (class 1259 OID 23484)
...
--
-- TOC entry 5523 (class 1259 OID 23451)
...
--
-- TOC entry 5517 (class 1259 OID 23427)
...
--
-- TOC entry 5555 (class 1259 OID 23746)
...
--
-- TOC entry 5556 (class 1259 OID 23747)
...
--
-- TOC entry 5561 (class 1259 OID 23789)
...
--
-- TOC entry 5562 (class 1259 OID 23790)
...
--
-- TOC entry 5575 (class 1259 OID 23922)
...
--
-- TOC entry 5550 (class 1259 OID 23654)
...
--
-- TOC entry 5380 (class 1259 OID 18956)
...
--
-- TOC entry 5381 (class 1259 OID 17286)
...
--
-- TOC entry 5382 (class 1259 OID 18082)
...
--
-- TOC entry 5383 (class 1259 OID 17285)
...
--
-- TOC entry 5442 (class 1259 OID 19866)
...
--
-- TOC entry 5443 (class 1259 OID 19041)
...
--
-- TOC entry 5450 (class 1259 OID 19095)
...
--
-- TOC entry 5410 (class 1259 OID 18528)
...
--
-- TOC entry 5411 (class 1259 OID 19799)
...
--
-- TOC entry 5412 (class 1259 OID 18531)
...
--
-- TOC entry 5413 (class 1259 OID 19772)
...
--
-- TOC entry 5414 (class 1259 OID 18530)
...
--
-- TOC entry 5447 (class 1259 OID 19067)
...
--
-- TOC entry 5393 (class 1259 OID 18350)
...
--
-- TOC entry 5502 (class 1259 OID 23215)
...
--
-- TOC entry 5520 (class 1259 OID 24238)
...
--
-- TOC entry 5388 (class 1259 OID 18349)
...
--
-- TOC entry 5444 (class 1259 OID 19865)
...
--
-- TOC entry 5415 (class 1259 OID 18772)
...
--
-- TOC entry 5357 (class 1259 OID 17192)
...
--
-- TOC entry 5511 (class 1259 OID 23281)
...
--
-- TOC entry 5512 (class 1259 OID 23282)
...
--
-- TOC entry 5503 (class 1259 OID 23280)
...
--
-- TOC entry 5504 (class 1259 OID 23279)
...
--
-- TOC entry 5363 (class 1259 OID 16988)
...
--
-- TOC entry 5364 (class 1259 OID 16987)
...
--
-- TOC entry 5394 (class 1259 OID 18161)
...
--
-- TOC entry 5545 (class 1259 OID 23613)
...
--
-- TOC entry 5395 (class 1259 OID 18131)
...
--
-- TOC entry 5418 (class 1259 OID 18567)
...
--
-- TOC entry 5350 (class 1259 OID 18749)
...
--
-- TOC entry 5355 (class 1259 OID 18332)
...
--
-- TOC entry 5362 (class 1259 OID 16967)
...
--
-- TOC entry 5377 (class 1259 OID 18583)
...
--
-- TOC entry 5378 (class 1259 OID 17255)
...
--
-- TOC entry 5379 (class 1259 OID 18731)
...
--
-- TOC entry 5548 (class 1259 OID 23611)
...
--
-- TOC entry 5549 (class 1259 OID 23612)
...
--
-- TOC entry 5356 (class 1259 OID 18315)
...
--
-- TOC entry 5406 (class 1259 OID 18405)
...
--
-- TOC entry 5407 (class 1259 OID 18435)
...
--
-- TOC entry 5431 (class 1259 OID 18974)
...
--
-- TOC entry 5434 (class 1259 OID 19003)
...
--
-- TOC entry 5435 (class 1259 OID 19654)
...
--
-- TOC entry 5436 (class 1259 OID 19876)
...
--
-- TOC entry 5437 (class 1259 OID 19656)
...
--
-- TOC entry 5438 (class 1259 OID 19657)
...
--
-- TOC entry 5439 (class 1259 OID 19655)
...
--
-- TOC entry 5798 (class 2620 OID 19556)
...
--
-- TOC entry 5799 (class 2620 OID 19303)
...
--
-- TOC entry 5840 (class 2620 OID 24142)
...
--
-- TOC entry 5850 (class 2620 OID 24312)
-- Name: lor_reconciliation_source_run trg_copy_lor_authority_chain; Type: TRIGGER; Schema: ops; Owner: msbadmin
--

CREATE TRIGGER trg_copy_lor_authority_chain BEFORE INSERT ON ops.lor_reconciliation_source_run FOR EACH ROW EXECUTE FUNCTION ops.trg_copy_lor_authority_chain();


--
-- TOC entry 5804 (class 2620 OID 19144)
...
--
-- TOC entry 5805 (class 2620 OID 19191)
...
--
-- TOC entry 5806 (class 2620 OID 19176)
...
--
-- TOC entry 5844 (class 2620 OID 23537)
...
--
-- TOC entry 5842 (class 2620 OID 23511)
...
--
-- TOC entry 5841 (class 2620 OID 23555)
...
--
-- TOC entry 5839 (class 2620 OID 23554)
...
--
-- TOC entry 5845 (class 2620 OID 23556)
...
--
-- TOC entry 5848 (class 2620 OID 23748)
...
--
-- TOC entry 5849 (class 2620 OID 23791)
...
--
-- TOC entry 5852 (class 2620 OID 23925)
...
--
-- TOC entry 5851 (class 2620 OID 23924)
...
--
-- TOC entry 5853 (class 2620 OID 23926)
...
--
-- TOC entry 5847 (class 2620 OID 23655)
...
--
-- TOC entry 5836 (class 2620 OID 23943)
...
--
-- TOC entry 5837 (class 2620 OID 24389)
-- Name: lor_reconciliation_run trg_set_cancelled_reconciliation_completed_at; Type: TRIGGER; Schema: ops; Owner: msbadmin
--

CREATE TRIGGER trg_set_cancelled_reconciliation_completed_at BEFORE INSERT OR UPDATE OF status, completed_at, cancelled_at, report_published_at ON ops.lor_reconciliation_run FOR EACH ROW EXECUTE FUNCTION ops.f_set_cancelled_reconciliation_completed_at();


--
-- TOC entry 5800 (class 2620 OID 19298)
...
--
-- TOC entry 5801 (class 2620 OID 19302)
...
--
-- TOC entry 5838 (class 2620 OID 24054)
...
--
-- TOC entry 5843 (class 2620 OID 24538)
-- Name: lor_reconciliation_action trg_sync_lor_reconciliation_readiness_after_action; Type: TRIGGER; Schema: ops; Owner: msbadmin
--

CREATE TRIGGER trg_sync_lor_reconciliation_readiness_after_action AFTER INSERT ON ops.lor_reconciliation_action FOR EACH ROW EXECUTE FUNCTION ops.f_sync_lor_reconciliation_readiness_after_action();


--
-- TOC entry 5802 (class 2620 OID 19145)
...
--
-- TOC entry 5803 (class 2620 OID 19192)
...
--
-- TOC entry 5807 (class 2620 OID 19561)
...
--
-- TOC entry 5826 (class 2620 OID 19825)
...
--
-- TOC entry 5827 (class 2620 OID 19826)
...
--
-- TOC entry 5815 (class 2620 OID 19575)
...
--
-- TOC entry 5829 (class 2620 OID 19119)
...
--
-- TOC entry 5816 (class 2620 OID 19823)
...
--
-- TOC entry 5817 (class 2620 OID 19824)
...
--
-- TOC entry 5828 (class 2620 OID 19124)
...
--
-- TOC entry 5830 (class 2620 OID 19226)
...
--
-- TOC entry 5831 (class 2620 OID 19225)
...
--
-- TOC entry 5809 (class 2620 OID 19172)
...
--
-- TOC entry 5810 (class 2620 OID 19174)
...
--
-- TOC entry 5789 (class 2620 OID 19177)
...
--
-- TOC entry 5790 (class 2620 OID 19178)
...
--
-- TOC entry 5820 (class 2620 OID 19195)
...
--
-- TOC entry 5821 (class 2620 OID 19196)
...
--
-- TOC entry 5787 (class 2620 OID 19183)
...
--
-- TOC entry 5788 (class 2620 OID 19184)
...
--
-- TOC entry 5863 (class 2620 OID 25485)
-- Name: controller trg_controller_actor_insert; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_actor_insert BEFORE INSERT ON ref.controller FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_insert();


--
-- TOC entry 5864 (class 2620 OID 25486)
-- Name: controller trg_controller_actor_update; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_actor_update BEFORE UPDATE ON ref.controller FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_update();


--
-- TOC entry 5866 (class 2620 OID 25487)
-- Name: controller_display trg_controller_display_actor_insert; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_display_actor_insert BEFORE INSERT ON ref.controller_display FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_insert();


--
-- TOC entry 5867 (class 2620 OID 25488)
-- Name: controller_display trg_controller_display_actor_update; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_display_actor_update BEFORE UPDATE ON ref.controller_display FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_update();


--
-- TOC entry 5868 (class 2620 OID 25489)
-- Name: controller_firmware_history trg_controller_firmware_history_actor_insert; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_firmware_history_actor_insert BEFORE INSERT ON ref.controller_firmware_history FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_insert();


--
-- TOC entry 5869 (class 2620 OID 25490)
-- Name: controller_firmware_history trg_controller_firmware_history_actor_update; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_firmware_history_actor_update BEFORE UPDATE ON ref.controller_firmware_history FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_update();


--
-- TOC entry 5859 (class 2620 OID 25301)
-- Name: controller_firmware_version trg_controller_firmware_version_actor_insert; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_firmware_version_actor_insert BEFORE INSERT ON ref.controller_firmware_version FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_insert();


--
-- TOC entry 5860 (class 2620 OID 25302)
-- Name: controller_firmware_version trg_controller_firmware_version_actor_update; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_firmware_version_actor_update BEFORE UPDATE ON ref.controller_firmware_version FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_update();


--
-- TOC entry 5856 (class 2620 OID 25299)
-- Name: controller_model trg_controller_model_actor_insert; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_model_actor_insert BEFORE INSERT ON ref.controller_model FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_insert();


--
-- TOC entry 5857 (class 2620 OID 25300)
-- Name: controller_model trg_controller_model_actor_update; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_model_actor_update BEFORE UPDATE ON ref.controller_model FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_update();


--
-- TOC entry 5858 (class 2620 OID 25521)
-- Name: controller_model trg_controller_model_validate_uid_capacity; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_model_validate_uid_capacity BEFORE UPDATE OF lor_uid_capacity ON ref.controller_model FOR EACH ROW EXECUTE FUNCTION ref.validate_controller_model_uid_capacity();


--
-- TOC entry 5861 (class 2620 OID 25483)
-- Name: controller_status trg_controller_status_actor_insert; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_status_actor_insert BEFORE INSERT ON ref.controller_status FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_insert();


--
-- TOC entry 5862 (class 2620 OID 25484)
-- Name: controller_status trg_controller_status_actor_update; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_status_actor_update BEFORE UPDATE ON ref.controller_status FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_update();


--
-- TOC entry 5865 (class 2620 OID 25519)
-- Name: controller trg_controller_validate_lor_configuration; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_controller_validate_lor_configuration BEFORE INSERT OR UPDATE OF controller_model_id, lor_network, lor_uid_start, lor_uid_count ON ref.controller FOR EACH ROW EXECUTE FUNCTION ref.validate_controller_lor_configuration();


--
-- TOC entry 5797 (class 2620 OID 19180)
...
--
-- TOC entry 5785 (class 2620 OID 19185)
...
--
-- TOC entry 5786 (class 2620 OID 19186)
...
--
-- TOC entry 5818 (class 2620 OID 19197)
...
--
-- TOC entry 5819 (class 2620 OID 19198)
...
--
-- TOC entry 5781 (class 2620 OID 19187)
...
--
-- TOC entry 5782 (class 2620 OID 19188)
...
--
-- TOC entry 5795 (class 2620 OID 19199)
...
--
-- TOC entry 5796 (class 2620 OID 19200)
...
--
-- TOC entry 5854 (class 2620 OID 25150)
-- Name: label_template trg_label_template_set_actor_insert; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_label_template_set_actor_insert BEFORE INSERT ON ref.label_template FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_insert();


--
-- TOC entry 5855 (class 2620 OID 25151)
-- Name: label_template trg_label_template_set_actor_update; Type: TRIGGER; Schema: ref; Owner: msbadmin
--

CREATE TRIGGER trg_label_template_set_actor_update BEFORE UPDATE ON ref.label_template FOR EACH ROW EXECUTE FUNCTION ref.set_actor_on_update();


--
-- TOC entry 5835 (class 2620 OID 24169)
...
--
-- TOC entry 5834 (class 2620 OID 24167)
...
--
-- TOC entry 5793 (class 2620 OID 19189)
...
--
-- TOC entry 5794 (class 2620 OID 19190)
...
--
-- TOC entry 5832 (class 2620 OID 19494)
...
--
-- TOC entry 5833 (class 2620 OID 19495)
...
--
-- TOC entry 5846 (class 2620 OID 24165)
...
--
-- TOC entry 5808 (class 2620 OID 19182)
...
--
-- TOC entry 5792 (class 2620 OID 19181)
...
--
-- TOC entry 5791 (class 2620 OID 19300)
...
--
-- TOC entry 5811 (class 2620 OID 19201)
...
--
-- TOC entry 5812 (class 2620 OID 19202)
...
--
-- TOC entry 5783 (class 2620 OID 19193)
...
--
-- TOC entry 5784 (class 2620 OID 19194)
...
--
-- TOC entry 5813 (class 2620 OID 19203)
...
--
-- TOC entry 5814 (class 2620 OID 19204)
...
--
-- TOC entry 5822 (class 2620 OID 20088)
...
--
-- TOC entry 5823 (class 2620 OID 20098)
...
--
-- TOC entry 5824 (class 2620 OID 19845)
...
--
-- TOC entry 5825 (class 2620 OID 19846)
...
--
-- TOC entry 5608 (class 2606 OID 16464)
...
--
-- TOC entry 5609 (class 2606 OID 16474)
...
--
-- TOC entry 5610 (class 2606 OID 16469)
...
--
-- TOC entry 5726 (class 2606 OID 23026)
...
--
-- TOC entry 5725 (class 2606 OID 23016)
...
--
-- TOC entry 5602 (class 2606 OID 16409)
...
--
-- TOC entry 5603 (class 2606 OID 16423)
...
--
-- TOC entry 5604 (class 2606 OID 16428)
...
--
-- TOC entry 5605 (class 2606 OID 16442)
...
--
-- TOC entry 5606 (class 2606 OID 16447)
...
--
-- TOC entry 5607 (class 2606 OID 16452)
...
--
-- TOC entry 5721 (class 2606 OID 20738)
...
--
-- TOC entry 5722 (class 2606 OID 20733)
...
--
-- TOC entry 5716 (class 2606 OID 20703)
...
--
-- TOC entry 5717 (class 2606 OID 20698)
...
--
-- TOC entry 5654 (class 2606 OID 17299)
...
--
-- TOC entry 5723 (class 2606 OID 20768)
...
--
-- TOC entry 5724 (class 2606 OID 20773)
...
--
-- TOC entry 5720 (class 2606 OID 20763)
...
--
-- TOC entry 5712 (class 2606 OID 20812)
...
--
-- TOC entry 5713 (class 2606 OID 20668)
...
--
-- TOC entry 5718 (class 2606 OID 20750)
...
--
-- TOC entry 5719 (class 2606 OID 20755)
...
--
-- TOC entry 5714 (class 2606 OID 25530)
-- Name: display_label_batch fk_display_label_batch_label_template; Type: FK CONSTRAINT; Schema: ops; Owner: msbadmin
--

ALTER TABLE ONLY ops.display_label_batch
    ADD CONSTRAINT fk_display_label_batch_label_template FOREIGN KEY (label_template_id) REFERENCES ref.label_template(label_template_id);


--
-- TOC entry 5715 (class 2606 OID 20745)
...
--
-- TOC entry 5710 (class 2606 OID 20817)
...
--
-- TOC entry 5711 (class 2606 OID 20663)
...
--
-- TOC entry 5655 (class 2606 OID 19267)
...
--
-- TOC entry 5656 (class 2606 OID 19257)
...
--
-- TOC entry 5657 (class 2606 OID 18933)
...
--
-- TOC entry 5658 (class 2606 OID 18928)
...
--
-- TOC entry 5659 (class 2606 OID 19262)
...
--
-- TOC entry 5727 (class 2606 OID 23200)
...
--
-- TOC entry 5741 (class 2606 OID 23504)
...
--
-- TOC entry 5742 (class 2606 OID 23499)
...
--
-- TOC entry 5728 (class 2606 OID 23195)
...
--
-- TOC entry 5729 (class 2606 OID 23210)
...
--
-- TOC entry 5730 (class 2606 OID 23205)
...
--
-- TOC entry 5743 (class 2606 OID 23522)
...
--
-- TOC entry 5744 (class 2606 OID 23527)
...
--
-- TOC entry 5745 (class 2606 OID 23532)
...
--
-- TOC entry 5738 (class 2606 OID 23478)
...
--
-- TOC entry 5739 (class 2606 OID 23473)
...
--
-- TOC entry 5740 (class 2606 OID 23468)
...
--
-- TOC entry 5737 (class 2606 OID 23446)
...
--
-- TOC entry 5746 (class 2606 OID 23549)
...
--
-- TOC entry 5645 (class 2606 OID 19527)
...
--
-- TOC entry 5646 (class 2606 OID 18951)
...
--
-- TOC entry 5647 (class 2606 OID 19247)
...
--
-- TOC entry 5648 (class 2606 OID 19532)
...
--
-- TOC entry 5649 (class 2606 OID 19549)
...
--
-- TOC entry 5650 (class 2606 OID 19497)
...
--
-- TOC entry 5651 (class 2606 OID 19522)
...
--
-- TOC entry 5652 (class 2606 OID 19252)
...
--
-- TOC entry 5653 (class 2606 OID 19537)
...
--
-- TOC entry 5694 (class 2606 OID 19923)
...
--
-- TOC entry 5695 (class 2606 OID 19918)
...
--
-- TOC entry 5697 (class 2606 OID 24067)
...
--
-- TOC entry 5703 (class 2606 OID 19085)
...
--
-- TOC entry 5704 (class 2606 OID 19090)
...
--
-- TOC entry 5705 (class 2606 OID 19080)
...
--
-- TOC entry 5698 (class 2606 OID 19933)
...
--
-- TOC entry 5699 (class 2606 OID 19938)
...
--
-- TOC entry 5669 (class 2606 OID 19903)
...
--
-- TOC entry 5670 (class 2606 OID 19908)
...
--
-- TOC entry 5671 (class 2606 OID 18762)
...
--
-- TOC entry 5672 (class 2606 OID 18767)
...
--
-- TOC entry 5706 (class 2606 OID 19282)
...
--
-- TOC entry 5707 (class 2606 OID 19287)
...
--
-- TOC entry 5673 (class 2606 OID 19814)
...
--
-- TOC entry 5674 (class 2606 OID 20038)
...
--
-- TOC entry 5675 (class 2606 OID 18504)
...
--
-- TOC entry 5676 (class 2606 OID 20089)
...
--
-- TOC entry 5677 (class 2606 OID 19913)
...
--
-- TOC entry 5678 (class 2606 OID 19787)
...
--
-- TOC entry 5679 (class 2606 OID 18499)
...
--
-- TOC entry 5700 (class 2606 OID 19062)
...
--
-- TOC entry 5701 (class 2606 OID 19057)
...
--
-- TOC entry 5702 (class 2606 OID 19052)
...
--
-- TOC entry 5736 (class 2606 OID 23933)
...
--
-- TOC entry 5753 (class 2606 OID 23736)
...
--
-- TOC entry 5754 (class 2606 OID 23731)
...
--
-- TOC entry 5755 (class 2606 OID 23741)
...
--
-- TOC entry 5756 (class 2606 OID 23774)
...
--
-- TOC entry 5757 (class 2606 OID 23769)
...
--
-- TOC entry 5758 (class 2606 OID 23784)
...
--
-- TOC entry 5759 (class 2606 OID 23779)
...
--
-- TOC entry 5760 (class 2606 OID 23764)
...
--
-- TOC entry 5762 (class 2606 OID 23903)
...
--
-- TOC entry 5761 (class 2606 OID 23887)
...
--
-- TOC entry 5763 (class 2606 OID 23917)
...
--
-- TOC entry 5748 (class 2606 OID 23634)
...
--
-- TOC entry 5749 (class 2606 OID 23629)
...
--
-- TOC entry 5750 (class 2606 OID 23644)
...
--
-- TOC entry 5751 (class 2606 OID 23639)
...
--
-- TOC entry 5752 (class 2606 OID 23649)
...
--
-- TOC entry 5660 (class 2606 OID 18742)
...
--
-- TOC entry 5708 (class 2606 OID 19227)
...
--
-- TOC entry 5709 (class 2606 OID 19232)
...
--
-- TOC entry 5619 (class 2606 OID 19324)
...
--
-- TOC entry 5663 (class 2606 OID 19242)
...
--
-- TOC entry 5664 (class 2606 OID 19237)
...
--
-- TOC entry 5620 (class 2606 OID 18915)
...
--
-- TOC entry 5621 (class 2606 OID 21095)
...
--
-- TOC entry 5617 (class 2606 OID 19334)
...
--
-- TOC entry 5618 (class 2606 OID 19339)
...
--
-- TOC entry 5622 (class 2606 OID 19329)
...
--
-- TOC entry 5767 (class 2606 OID 25413)
-- Name: controller fk_controller_current_location; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller
    ADD CONSTRAINT fk_controller_current_location FOREIGN KEY (current_location_code) REFERENCES ref.storage_location(location_code);


--
-- TOC entry 5775 (class 2606 OID 25439)
-- Name: controller_display fk_controller_display_controller; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_display
    ADD CONSTRAINT fk_controller_display_controller FOREIGN KEY (controller_id) REFERENCES ref.controller(controller_id);


--
-- TOC entry 5776 (class 2606 OID 25444)
-- Name: controller_display fk_controller_display_display; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_display
    ADD CONSTRAINT fk_controller_display_display FOREIGN KEY (display_id) REFERENCES ref.display(display_id);


--
-- TOC entry 5777 (class 2606 OID 25449)
-- Name: controller_display fk_controller_display_wiring_source; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_display
    ADD CONSTRAINT fk_controller_display_wiring_source FOREIGN KEY (wiring_source_display_id) REFERENCES ref.display(display_id);


--
-- TOC entry 5778 (class 2606 OID 25468)
-- Name: controller_firmware_history fk_controller_firmware_history_controller; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_firmware_history
    ADD CONSTRAINT fk_controller_firmware_history_controller FOREIGN KEY (controller_id) REFERENCES ref.controller(controller_id);


--
-- TOC entry 5779 (class 2606 OID 25478)
-- Name: controller_firmware_history fk_controller_firmware_history_verified_by; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_firmware_history
    ADD CONSTRAINT fk_controller_firmware_history_verified_by FOREIGN KEY (verified_by_person_id) REFERENCES ref.person(person_id);


--
-- TOC entry 5780 (class 2606 OID 25473)
-- Name: controller_firmware_history fk_controller_firmware_history_version; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_firmware_history
    ADD CONSTRAINT fk_controller_firmware_history_version FOREIGN KEY (controller_firmware_version_id) REFERENCES ref.controller_firmware_version(controller_firmware_version_id);


--
-- TOC entry 5768 (class 2606 OID 25408)
-- Name: controller fk_controller_firmware_verified_by; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller
    ADD CONSTRAINT fk_controller_firmware_verified_by FOREIGN KEY (firmware_verified_by_person_id) REFERENCES ref.person(person_id);


--
-- TOC entry 5766 (class 2606 OID 25294)
-- Name: controller_firmware_version fk_controller_firmware_version_model; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller_firmware_version
    ADD CONSTRAINT fk_controller_firmware_version_model FOREIGN KEY (controller_model_id) REFERENCES ref.controller_model(controller_model_id);


--
-- TOC entry 5769 (class 2606 OID 25403)
-- Name: controller fk_controller_installed_firmware; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller
    ADD CONSTRAINT fk_controller_installed_firmware FOREIGN KEY (controller_model_id, installed_firmware_version_id) REFERENCES ref.controller_firmware_version(controller_model_id, controller_firmware_version_id);


--
-- TOC entry 5770 (class 2606 OID 25418)
-- Name: controller fk_controller_label_last_by; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller
    ADD CONSTRAINT fk_controller_label_last_by FOREIGN KEY (label_print_last_by_cached_id) REFERENCES ref.person(person_id);


--
-- TOC entry 5771 (class 2606 OID 25423)
-- Name: controller fk_controller_label_template; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller
    ADD CONSTRAINT fk_controller_label_template FOREIGN KEY (label_template_id) REFERENCES ref.label_template(label_template_id);


--
-- TOC entry 5772 (class 2606 OID 25393)
-- Name: controller fk_controller_model; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller
    ADD CONSTRAINT fk_controller_model FOREIGN KEY (controller_model_id) REFERENCES ref.controller_model(controller_model_id);


--
-- TOC entry 5773 (class 2606 OID 25508)
-- Name: controller fk_controller_programmed_config_verified_by; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller
    ADD CONSTRAINT fk_controller_programmed_config_verified_by FOREIGN KEY (programmed_config_verified_by_person_id) REFERENCES ref.person(person_id);


--
-- TOC entry 5774 (class 2606 OID 25398)
-- Name: controller fk_controller_status; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.controller
    ADD CONSTRAINT fk_controller_status FOREIGN KEY (controller_status_id) REFERENCES ref.controller_status(controller_status_id);


--
-- TOC entry 5634 (class 2606 OID 19344)
...
--
-- TOC entry 5636 (class 2606 OID 17199)
...
--
-- TOC entry 5637 (class 2606 OID 17062)
...
--
-- TOC entry 5638 (class 2606 OID 21090)
...
--
-- TOC entry 5639 (class 2606 OID 25153)
-- Name: display fk_display_label_template; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.display
    ADD CONSTRAINT fk_display_label_template FOREIGN KEY (label_template_id) REFERENCES ref.label_template(label_template_id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- TOC entry 5640 (class 2606 OID 17077)
...
--
-- TOC entry 5641 (class 2606 OID 17067)
...
--
-- TOC entry 5615 (class 2606 OID 19354)
...
--
-- TOC entry 5616 (class 2606 OID 19359)
...
--
-- TOC entry 5682 (class 2606 OID 19364)
...
--
-- TOC entry 5683 (class 2606 OID 19369)
...
--
-- TOC entry 5642 (class 2606 OID 17194)
...
--
-- TOC entry 5643 (class 2606 OID 19349)
...
--
-- TOC entry 5611 (class 2606 OID 19374)
...
--
-- TOC entry 5612 (class 2606 OID 19379)
...
--
-- TOC entry 5632 (class 2606 OID 19384)
...
--
-- TOC entry 5633 (class 2606 OID 19389)
...
--
-- TOC entry 5764 (class 2606 OID 25140)
-- Name: label_template fk_label_template_created_by_person; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.label_template
    ADD CONSTRAINT fk_label_template_created_by_person FOREIGN KEY (created_by_person_id) REFERENCES ref.person(person_id);


--
-- TOC entry 5765 (class 2606 OID 25145)
-- Name: label_template fk_label_template_updated_by_person; Type: FK CONSTRAINT; Schema: ref; Owner: msbadmin
--

ALTER TABLE ONLY ref.label_template
    ADD CONSTRAINT fk_label_template_updated_by_person FOREIGN KEY (updated_by_person_id) REFERENCES ref.person(person_id);


--
-- TOC entry 5733 (class 2606 OID 23269)
...
--
-- TOC entry 5734 (class 2606 OID 23274)
...
--
-- TOC entry 5735 (class 2606 OID 23264)
...
--
-- TOC entry 5731 (class 2606 OID 23246)
...
--
-- TOC entry 5732 (class 2606 OID 23241)
...
--
-- TOC entry 5623 (class 2606 OID 18316)
...
--
-- TOC entry 5627 (class 2606 OID 19394)
...
--
-- TOC entry 5628 (class 2606 OID 19399)
...
--
-- TOC entry 5629 (class 2606 OID 19404)
...
--
-- TOC entry 5630 (class 2606 OID 19409)
...
--
-- TOC entry 5680 (class 2606 OID 19414)
...
--
-- TOC entry 5681 (class 2606 OID 19419)
...
--
-- TOC entry 5661 (class 2606 OID 19424)
...
--
-- TOC entry 5662 (class 2606 OID 19429)
...
--
-- TOC entry 5625 (class 2606 OID 19434)
...
--
-- TOC entry 5626 (class 2606 OID 19439)
...
--
-- TOC entry 5665 (class 2606 OID 19444)
...
--
-- TOC entry 5666 (class 2606 OID 19449)
...
--
-- TOC entry 5613 (class 2606 OID 19454)
...
--
-- TOC entry 5614 (class 2606 OID 19459)
...
--
-- TOC entry 5667 (class 2606 OID 19464)
...
--
-- TOC entry 5668 (class 2606 OID 19469)
...
--
-- TOC entry 5684 (class 2606 OID 19474)
...
--
-- TOC entry 5685 (class 2606 OID 19479)
...
--
-- TOC entry 5624 (class 2606 OID 16834)
...
--
-- TOC entry 5631 (class 2606 OID 16980)
...
--
-- TOC entry 5644 (class 2606 OID 18335)
...
--
-- TOC entry 5747 (class 2606 OID 23606)
...
--
-- TOC entry 5686 (class 2606 OID 19943)
...
--
-- TOC entry 5687 (class 2606 OID 19987)
...
--
-- TOC entry 5688 (class 2606 OID 19634)
...
--
-- TOC entry 5689 (class 2606 OID 19948)
...
--
-- TOC entry 5690 (class 2606 OID 19644)
...
--
-- TOC entry 5691 (class 2606 OID 19992)
...
--
-- TOC entry 5692 (class 2606 OID 19649)
...
--
-- TOC entry 5693 (class 2606 OID 19639)
...
GRANT USAGE ON SCHEMA lor_snap TO msb_mcp_readonly;
GRANT USAGE ON SCHEMA lor_snap TO fieldwiring_app;
...
GRANT USAGE ON SCHEMA ops TO msb_mcp_readonly;
...
GRANT USAGE ON SCHEMA ref TO msb_mcp_readonly;
...
-- Dependencies: 938
-- Name: FUNCTION f_lor_governed_stage_roots(p_import_run_id bigint, p_stage_key text); Type: ACL; Schema: ops; Owner: msbadmin
--

REVOKE ALL ON FUNCTION ops.f_lor_governed_stage_roots(p_import_run_id bigint, p_stage_key text) FROM PUBLIC;
GRANT ALL ON FUNCTION ops.f_lor_governed_stage_roots(p_import_run_id bigint, p_stage_key text) TO directus_app;
GRANT ALL ON FUNCTION ops.f_lor_governed_stage_roots(p_import_run_id bigint, p_stage_key text) TO lor_preflight_app;
...
-- Dependencies: 922
-- Name: FUNCTION f_normalize_lor_stage_name(p_source_name text, p_stage_key text); Type: ACL; Schema: ops; Owner: msbadmin
--

REVOKE ALL ON FUNCTION ops.f_normalize_lor_stage_name(p_source_name text, p_stage_key text) FROM PUBLIC;
GRANT ALL ON FUNCTION ops.f_normalize_lor_stage_name(p_source_name text, p_stage_key text) TO directus_app;
GRANT ALL ON FUNCTION ops.f_normalize_lor_stage_name(p_source_name text, p_stage_key text) TO lor_preflight_app;
...
-- Dependencies: 776
-- Name: FUNCTION f_record_lor_stage_authority_action(p_lor_reconciliation_run_id bigint, p_lor_reconciliation_group_id bigint, p_action_type text, p_reason text, p_acted_by_application text); Type: ACL; Schema: ops; Owner: msbadmin
--

REVOKE ALL ON FUNCTION ops.f_record_lor_stage_authority_action(p_lor_reconciliation_run_id bigint, p_lor_reconciliation_group_id bigint, p_action_type text, p_reason text, p_acted_by_application text) FROM PUBLIC;
GRANT ALL ON FUNCTION ops.f_record_lor_stage_authority_action(p_lor_reconciliation_run_id bigint, p_lor_reconciliation_group_id bigint, p_action_type text, p_reason text, p_acted_by_application text) TO directus_app;
GRANT ALL ON FUNCTION ops.f_record_lor_stage_authority_action(p_lor_reconciliation_run_id bigint, p_lor_reconciliation_group_id bigint, p_action_type text, p_reason text, p_acted_by_application text) TO lor_preflight_app;
...
GRANT ALL ON FUNCTION ops.f_record_lor_stage_preserve_metadata_action(p_lor_reconciliation_run_id bigint, p_lor_reconciliation_group_id bigint, p_reason text, p_acted_by_application text) TO lor_preflight_app;


--
-- TOC entry 6097 (class 0 OID 0)
-- Dependencies: 833
-- Name: FUNCTION f_set_cancelled_reconciliation_completed_at(); Type: ACL; Schema: ops; Owner: msbadmin
--

REVOKE ALL ON FUNCTION ops.f_set_cancelled_reconciliation_completed_at() FROM PUBLIC;
GRANT ALL ON FUNCTION ops.f_set_cancelled_reconciliation_completed_at() TO directus_app;


--
-- TOC entry 6099 (class 0 OID 0)
-- Dependencies: 1299
-- Name: FUNCTION f_stage_group_can_add_new_stage(p_lor_reconciliation_group_id bigint); Type: ACL; Schema: ops; Owner: msbadmin
--

REVOKE ALL ON FUNCTION ops.f_stage_group_can_add_new_stage(p_lor_reconciliation_group_id bigint) FROM PUBLIC;
GRANT ALL ON FUNCTION ops.f_stage_group_can_add_new_stage(p_lor_reconciliation_group_id bigint) TO directus_app;
GRANT ALL ON FUNCTION ops.f_stage_group_can_add_new_stage(p_lor_reconciliation_group_id bigint) TO lor_preflight_app;


--
-- TOC entry 6100 (class 0 OID 0)
-- Dependencies: 1318
-- Name: FUNCTION f_stage_group_can_approve_change(p_lor_reconciliation_group_id bigint); Type: ACL; Schema: ops; Owner: msbadmin
--

REVOKE ALL ON FUNCTION ops.f_stage_group_can_approve_change(p_lor_reconciliation_group_id bigint) FROM PUBLIC;
GRANT ALL ON FUNCTION ops.f_stage_group_can_approve_change(p_lor_reconciliation_group_id bigint) TO directus_app;
GRANT ALL ON FUNCTION ops.f_stage_group_can_approve_change(p_lor_reconciliation_group_id bigint) TO lor_preflight_app;
...
-- Dependencies: 686
-- Name: FUNCTION f_stage_group_has_only_accepted_binding_keys(p_lor_reconciliation_group_id bigint); Type: ACL; Schema: ops; Owner: msbadmin
--

REVOKE ALL ON FUNCTION ops.f_stage_group_has_only_accepted_binding_keys(p_lor_reconciliation_group_id bigint) FROM PUBLIC;
GRANT ALL ON FUNCTION ops.f_stage_group_has_only_accepted_binding_keys(p_lor_reconciliation_group_id bigint) TO directus_app;
GRANT ALL ON FUNCTION ops.f_stage_group_has_only_accepted_binding_keys(p_lor_reconciliation_group_id bigint) TO lor_preflight_app;


--
-- TOC entry 6104 (class 0 OID 0)
-- Dependencies: 1280
-- Name: FUNCTION f_stage_group_new_stage_key(p_lor_reconciliation_group_id bigint); Type: ACL; Schema: ops; Owner: msbadmin
--

REVOKE ALL ON FUNCTION ops.f_stage_group_new_stage_key(p_lor_reconciliation_group_id bigint) FROM PUBLIC;
GRANT ALL ON FUNCTION ops.f_stage_group_new_stage_key(p_lor_reconciliation_group_id bigint) TO directus_app;
...
-- Dependencies: 1253
-- Name: FUNCTION f_sync_lor_reconciliation_readiness_after_action(); Type: ACL; Schema: ops; Owner: msbadmin
--

REVOKE ALL ON FUNCTION ops.f_sync_lor_reconciliation_readiness_after_action() FROM PUBLIC;
GRANT ALL ON FUNCTION ops.f_sync_lor_reconciliation_readiness_after_action() TO directus_app;
...
-- Dependencies: 1097
-- Name: FUNCTION trg_copy_lor_authority_chain(); Type: ACL; Schema: ops; Owner: msbadmin
--

GRANT ALL ON FUNCTION ops.trg_copy_lor_authority_chain() TO directus_app;
...
-- Dependencies: 533
-- Name: PROCEDURE p1_promote_stage_from_reconciliation_before_0032(IN p_lor_reconciliation_run_id bigint); Type: ACL; Schema: ref; Owner: msbadmin
--

REVOKE ALL ON PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0032(IN p_lor_reconciliation_run_id bigint) FROM PUBLIC;
GRANT ALL ON PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0032(IN p_lor_reconciliation_run_id bigint) TO directus_app;


--
-- TOC entry 6144 (class 0 OID 0)
-- Dependencies: 723
-- Name: PROCEDURE p1_promote_stage_from_reconciliation_before_0033(IN p_lor_reconciliation_run_id bigint); Type: ACL; Schema: ref; Owner: msbadmin
--

REVOKE ALL ON PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0033(IN p_lor_reconciliation_run_id bigint) FROM PUBLIC;
GRANT ALL ON PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0033(IN p_lor_reconciliation_run_id bigint) TO directus_app;


--
-- TOC entry 6146 (class 0 OID 0)
-- Dependencies: 740
-- Name: PROCEDURE p1_promote_stage_from_reconciliation_before_0040(IN p_lor_reconciliation_run_id bigint); Type: ACL; Schema: ref; Owner: msbadmin
--

REVOKE ALL ON PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0040(IN p_lor_reconciliation_run_id bigint) FROM PUBLIC;
GRANT ALL ON PROCEDURE ref.p1_promote_stage_from_reconciliation_before_0040(IN p_lor_reconciliation_run_id bigint) TO directus_app;
...
-- Dependencies: 944
-- Name: FUNCTION validate_controller_lor_configuration(); Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT ALL ON FUNCTION ref.validate_controller_lor_configuration() TO directus_app;


--
-- TOC entry 6173 (class 0 OID 0)
-- Dependencies: 603
-- Name: FUNCTION validate_controller_model_uid_capacity(); Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT ALL ON FUNCTION ref.validate_controller_model_uid_capacity() TO directus_app;
...
GRANT SELECT ON TABLE ref.display TO msb_mcp_readonly;
GRANT SELECT ON TABLE ref.display TO fieldwiring_app;
...
GRANT SELECT ON TABLE lor_snap.v_current_run TO msb_mcp_readonly;
GRANT SELECT ON TABLE lor_snap.v_current_run TO fieldwiring_app;
...
GRANT SELECT ON TABLE lor_snap.v_current_dmx_channels TO msb_mcp_readonly;
GRANT SELECT ON TABLE lor_snap.v_current_dmx_channels TO fieldwiring_app;
...
GRANT SELECT ON TABLE lor_snap.v_current_previews TO msb_mcp_readonly;
GRANT SELECT ON TABLE lor_snap.v_current_previews TO fieldwiring_app;
...
GRANT SELECT ON TABLE lor_snap.v_current_props TO msb_mcp_readonly;
GRANT SELECT ON TABLE lor_snap.v_current_props TO fieldwiring_app;
...
GRANT SELECT ON TABLE lor_snap.v_current_sub_props TO msb_mcp_readonly;
...
GRANT SELECT ON TABLE lor_snap.preview_wiring_fieldlead_v6 TO msb_mcp_readonly;
GRANT SELECT ON TABLE lor_snap.preview_wiring_fieldlead_v6 TO fieldwiring_app;
...
GRANT SELECT ON TABLE lor_snap.v_current_scene_lor_props TO msb_mcp_readonly;
GRANT SELECT ON TABLE lor_snap.v_current_scene_lor_props TO fieldwiring_app;
...
GRANT SELECT ON TABLE lor_snap.v_current_scenes TO msb_mcp_readonly;
GRANT SELECT ON TABLE lor_snap.v_current_scenes TO fieldwiring_app;
...
GRANT SELECT ON TABLE lor_snap.v_display_lor_occurrence TO msb_mcp_readonly;
...
GRANT SELECT ON TABLE ref.display_status TO msb_mcp_readonly;
...
GRANT SELECT ON TABLE ops.v_lor_display_reconciliation TO msb_mcp_readonly;
...
GRANT SELECT ON TABLE ref.stage TO msb_mcp_readonly;
GRANT SELECT ON TABLE ref.stage TO fieldwiring_app;
...
-- Dependencies: 481
-- Name: TABLE controller; Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT SELECT,INSERT,UPDATE ON TABLE ref.controller TO directus_app;
GRANT SELECT ON TABLE ref.controller TO fieldwiring_app;


--
-- TOC entry 6361 (class 0 OID 0)
-- Dependencies: 480
-- Name: SEQUENCE controller_controller_id_seq; Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT SELECT,USAGE ON SEQUENCE ref.controller_controller_id_seq TO directus_app;


--
-- TOC entry 6362 (class 0 OID 0)
-- Dependencies: 482
-- Name: TABLE controller_display; Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT SELECT,INSERT,UPDATE ON TABLE ref.controller_display TO directus_app;
GRANT SELECT ON TABLE ref.controller_display TO fieldwiring_app;


--
-- TOC entry 6363 (class 0 OID 0)
-- Dependencies: 484
-- Name: TABLE controller_firmware_history; Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT SELECT,INSERT,UPDATE ON TABLE ref.controller_firmware_history TO directus_app;
GRANT SELECT ON TABLE ref.controller_firmware_history TO fieldwiring_app;


--
-- TOC entry 6364 (class 0 OID 0)
-- Dependencies: 483
-- Name: SEQUENCE controller_firmware_history_controller_firmware_history_id_seq; Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT SELECT,USAGE ON SEQUENCE ref.controller_firmware_history_controller_firmware_history_id_seq TO directus_app;


--
-- TOC entry 6365 (class 0 OID 0)
-- Dependencies: 477
-- Name: TABLE controller_firmware_version; Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT SELECT,INSERT,UPDATE ON TABLE ref.controller_firmware_version TO directus_app;
GRANT SELECT ON TABLE ref.controller_firmware_version TO fieldwiring_app;


--
-- TOC entry 6366 (class 0 OID 0)
-- Dependencies: 476
-- Name: SEQUENCE controller_firmware_version_controller_firmware_version_id_seq; Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT SELECT,USAGE ON SEQUENCE ref.controller_firmware_version_controller_firmware_version_id_seq TO directus_app;


--
-- TOC entry 6369 (class 0 OID 0)
-- Dependencies: 475
-- Name: TABLE controller_model; Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT SELECT,INSERT,UPDATE ON TABLE ref.controller_model TO directus_app;
GRANT SELECT ON TABLE ref.controller_model TO fieldwiring_app;


--
-- TOC entry 6370 (class 0 OID 0)
-- Dependencies: 474
-- Name: SEQUENCE controller_model_controller_model_id_seq; Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT SELECT,USAGE ON SEQUENCE ref.controller_model_controller_model_id_seq TO directus_app;


--
-- TOC entry 6371 (class 0 OID 0)
-- Dependencies: 479
-- Name: TABLE controller_status; Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT SELECT,INSERT,UPDATE ON TABLE ref.controller_status TO directus_app;
GRANT SELECT ON TABLE ref.controller_status TO fieldwiring_app;


--
-- TOC entry 6372 (class 0 OID 0)
-- Dependencies: 478
-- Name: SEQUENCE controller_status_controller_status_id_seq; Type: ACL; Schema: ref; Owner: msbadmin
--

GRANT SELECT,USAGE ON SEQUENCE ref.controller_status_controller_status_id_seq TO directus_app;
...
-- Dependencies: 473
-- Name: TABLE label_template; Type: ACL; Schema: ref; Owner: msbadmin
--
...
-- Dependencies: 472
-- Name: SEQUENCE label_template_label_template_id_seq; Type: ACL; Schema: ref; Owner: msbadmin
--
...
GRANT SELECT ON TABLE ref.lor_scene TO fieldwiring_app;
...
GRANT SELECT ON TABLE ref.lor_scene_display TO fieldwiring_app;
...
GRANT SELECT ON TABLE ref.person TO fieldwiring_app;
...
-- Dependencies: 485
-- Name: TABLE controller_directus_collections_backup_20260831; Type: ACL; Schema: stage; Owner: msbadmin
--

GRANT SELECT ON TABLE stage.controller_directus_collections_backup_20260831 TO directus_app;


--
-- TOC entry 6428 (class 0 OID 0)
-- Dependencies: 486
-- Name: TABLE controller_directus_fields_backup_20260831; Type: ACL; Schema: stage; Owner: msbadmin
--

GRANT SELECT ON TABLE stage.controller_directus_fields_backup_20260831 TO directus_app;


--
-- TOC entry 6429 (class 0 OID 0)
-- Dependencies: 488
-- Name: TABLE controller_directus_permissions_backup_20260831; Type: ACL; Schema: stage; Owner: msbadmin
--

GRANT SELECT ON TABLE stage.controller_directus_permissions_backup_20260831 TO directus_app;


--
-- TOC entry 6430 (class 0 OID 0)
-- Dependencies: 487
-- Name: TABLE controller_directus_relations_backup_20260831; Type: ACL; Schema: stage; Owner: msbadmin
--

GRANT SELECT ON TABLE stage.controller_directus_relations_backup_20260831 TO directus_app;
...
--
-- TOC entry 3725 (class 826 OID 17316)
...
--
-- TOC entry 3726 (class 826 OID 17312)
...
--
-- TOC entry 3731 (class 826 OID 17317)
...
--
-- TOC entry 3733 (class 826 OID 18829)
...
--
-- TOC entry 3728 (class 826 OID 17313)
...
--
-- TOC entry 3730 (class 826 OID 17318)
...
--
-- TOC entry 3732 (class 826 OID 18828)
...
--
-- TOC entry 3727 (class 826 OID 17314)
...
--
-- TOC entry 3734 (class 826 OID 17319)
...
--
-- TOC entry 3729 (class 826 OID 17315)
...
-- Completed on 2026-08-31 23:27:39

--
-- PostgreSQL database dump complete
--

\unrestrict J9WhhaS8SWzoLO69DVIbOl7seZMaXdasVFoczE40zwwivsg8KXSjf7nY4YTRsld
