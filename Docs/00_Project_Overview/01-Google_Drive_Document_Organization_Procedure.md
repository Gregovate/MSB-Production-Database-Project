# Repair or Organize an Existing Display Folder Stage / Scene
...
[Display Folder Operations Home](Display_Folder_Operations/README.md)
...
1. Run/open the current [Documentation Alignment Worklist](Display_Folder_Operations/Run_Folder_Alignment.md).
2. Pick one Stage.
...
5. Verify/add only the required marker files using [Add and Verify MSB Display Folder Marker Files](03-MSB_DB_Source_Folder_Marker_Operator_Procedure.md).
...
Use these rather than expanding this document into one large manual:

- [Run Folder Alignment](Display_Folder_Operations/Run_Folder_Alignment.md)
- [Align a Legacy Setup Document](Display_Folder_Operations/Align_Legacy_Setup_Documents.md)
- [Publish a Current Setup Instruction](Display_Folder_Operations/Publish_Current_Setup_Instruction.md)
