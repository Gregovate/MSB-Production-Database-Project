# Google Drive / Display Folder Operator Procedures

Use this page when you already know you need to maintain the Google Shared Drive **Display Folders** and want the exact procedure for the task.
