...
[↑ Display Folder Operations](README.md)
...
3. Use [Organize and Publish MSB Display Folder Documentation](../01-Google_Drive_Document_Organization_Procedure.md) for the actual document/folder work.
