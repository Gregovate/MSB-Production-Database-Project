# Stage / Sub-stage / Scene Folder Scaffold — Moved

This file is retained temporarily so existing repository links do not break during the documentation reorganization.

It is **not** the current operator authority.
