...
| Setup / Takedown / Procedure | VERIFIED — operator docs current and live portal integration confirmed | COMPLETE — live Setup screenshots extracted/cropped for operator use, stored under `Setup_and_Deployment/images/`, and referenced from current operator docs | COMPLETE for current conversion — Setup application/acceptance paths preserved; no working implementation files moved; current application/runtime authority and operator/engineering links reviewed | EXISTS | VERIFIED — live Production Portal v1.3 shows Setup actions and Setup Documentation opens the current canonical README | Production runtime accepted at `https://my.sheboyganlights.org/setup/`; plain-English operator portal, operatorSOP portal, 2025 review procedure, Manager guide, engineering portal/handoff, and acceptance docs are current. Greg supplied live browser evidence on 2026-09-22 that the Production portal is published and its Setup Documentation action opens the current README. Obsolete `my/committees/production/setup-takedown-testing/index.html` is not a current navigation dependency. |
...
- `Gregovate/MSB-Internal-Web-Backbone` issue **#10** — `Integrate Setup operator portal and /setup application`; live Production Portal v1.3 and canonical Setup Documentation link verified by Greg on 2026-09-22.
